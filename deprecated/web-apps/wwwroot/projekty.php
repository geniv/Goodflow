    ...
    <div class="main_content">
      ...
      <div class="content">
        <div class="content_left">
          <div class="article">
            <h2><a class="linkcolor" href="<?php print(URL); ?>projekt.php?nazov=mailto" title="Mailto" target="_self">Mailto</a></h2>
            <p>Toto je prvý projekt na ktorom sa začalo u nás pracovať. Bolo to 01.11.2009. V tomto projekte ide o to, urobiť čo najlepšiu aplikáciu, pomocou ktorej používateľ môže odoslač e-mail administrátorovi nejakých stránok. Jedná sa teda o súbor, ktorý bude zobrazovať formulár a o súbor, ktorý e-mail odošle na základe vyplnených údajov.</p>
          </div>
        </div>
