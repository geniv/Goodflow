...
class StaticMenu
{
   ...
   */
  private $oznacovat = "oz_class_span";  //Volba oznaceni v menu, muze obsahovat jen JEDEN typ!!
   ...
   */
  private $menu = array(array("main_href" => "", //uvedeni
                              "href" => "", //prvni sub odkaz bez &AMP
                              "odkaz" => "Úvod",
                              "title" => "",
                              "id" => "",
                              "class" => "uvod",
 ...
 */
  public function Menu()
  {
    ...
    for ($i = 0; $i < count($this->menu); $i++)
    {
      ...
      $podminka = ((($kam == $this->menu[$i]["main_href"]) || ($kam == $this->var->default && $this->menu[$i]["main_href"] == "")) && $this->go_default);
      ...
      $result .=
       "            <li{$class}>\n              <a href=\"{$mainhref}{$href}\"{$class} title=\"{$this->menu[$i]["odkaz"]}\"{$id}{$akce}>\n                {$span}<span class=\"nazev_sekce\">{$ozn_odkaz_l}{$this->menu[$i]["odkaz"]}{$ozn_odkaz_p}</span>\n              </a>\n              <span{$class}></span>\n            </li>\n";
    }
