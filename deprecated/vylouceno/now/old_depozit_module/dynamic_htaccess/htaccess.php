        ...
        case "add": //pridavani
          ...
          <form method=\"post\">
            <fieldset>
              ...
              poradi: <input type=\"text\" name=\"poradi\" value=\"{$this->PocetRadku(1)}\" />>0<br />
        ...
        case "edit":  //editace
          ...
          if ($res = @$this->sqlite->query("SELECT rewrite, poznamka, poradi FROM htaccess WHERE id={$id};", NULL, $error))
          {
            if ($res->numRows() == 1)
            {
              ...
              <form method=\"post\">
                <fieldset>
                  rewrite: <input type=\"text\" name=\"rewrite\" value=\"{$data->rewrite}\" /><br />
                  poznamka: <input type=\"text\" name=\"poznamka\" value=\"{$data->poznamka}\" />(max 300 zn.)<br />
