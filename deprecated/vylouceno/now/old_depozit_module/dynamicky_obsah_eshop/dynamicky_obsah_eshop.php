 ...
 */
  public function ObsahEshop()
  {
    ...
    $subadresa = (!Empty($_GET[$this->var->get_kam]) ? explode("-", $_GET[$this->var->get_kam]) : $this->PrvniPolozka());
        ...
        case "add": //pridavani
          ...
          <form method=\"post\" enctype=\"multipart/form-data\">
            <fieldset>
              ...
              výrobce: <input type=\"input\" name=\"vyrobce\" /> <br />
              popis: <textarea name=\"popis\"></textarea>* <br />
              publikace: <input type=\"input\" name=\"publikace\" value=\"".date("j.n.Y")."\" /> <br />
              kód: <input type=\"input\" name=\"kod\" /> <br />
              hmotnost: <input type=\"input\" name=\"hmotnost\" /> {$this->defhmo}<br />
              dph: <input type=\"input\" name=\"dph\" value=\"{$this->defdph}\" /> %<br />
              cena: <input type=\"input\" name=\"cena\" /> {$this->defmen}<br />
              obrázek: <input type=\"file\" name=\"obrazek\" /> <br />
              skladem: <input type=\"input\" name=\"skladem\" /> ks<br />
            ...
            if ($res->numRows() == 1)
            {
              ...
              <form method=\"post\" enctype=\"multipart/form-data\">
                <fieldset>
                  ...
                  výrobce: <input type=\"input\" name=\"vyrobce\" value=\"{$data->vyrobce}\" /> <br />
                  popis: <textarea name=\"popis\">{$data->popis}</textarea>* <br />
                  publikace: <input type=\"input\" name=\"publikace\" value=\"{$data->publikace}\" /> <br />
                  kód: <input type=\"input\" name=\"kod\" value=\"{$data->kod}\" /> <br />
                  hmotnost: <input type=\"input\" name=\"hmotnost\" value=\"{$data->hmotnost}\" /> {$this->defhmo}<br />
                  dph: <input type=\"input\" name=\"dph\" value=\"{$data->dph}\" /> %<br />
                  cena: <input type=\"input\" name=\"cena\" value=\"{$data->cena}\" /> {$this->defmen}<br />
                  <img src=\"{$this->dirpath}/{$this->pathcest}/{$this->minidir}/{$data->obrazek}\" alt=\"{$data->nazev}\" /><br />
                  obrázek: <input type=\"file\" name=\"obrazek\" /> <br />
                  skladem: <input type=\"input\" name=\"skladem\" value=\"{$data->skladem}\" /> <br />
