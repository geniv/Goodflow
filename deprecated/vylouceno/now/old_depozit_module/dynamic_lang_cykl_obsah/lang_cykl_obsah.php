 ...
 */
  public function __construct(&$var, $index) //konstruktor
  {
    ...
    $adresa_menu = array( array("main_href" => "{$this->idmodul}",
                                "odkaz" => "administrace multilanguage cyklického obsahu",
                                "title" => " - administrace multilanguage cyklického obsahu",
                                "id" => "",
                                "class" => "",
                                "akce" => ""),
                          );
        ...
        case "add": //pridavani
          ...
          <form method=\"post\">
            <fieldset>
              ...
              datum: <input type=\"text\" name=\"datum\" value=\"".date("j.n.Y")."\" /><br />
