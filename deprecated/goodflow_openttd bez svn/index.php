...
//------------------------------------------------------------------------------
  ...
  OpenTTDconfig::setPath(__DIR__, $weburl);

  $content = Html::div()->class('obal')
                        ->insert(Html::div()->class('menu')->insertContent(OpenTTDconfig::getMenu()))
                        ->insert(Html::div()->class('content')->insertContent(OpenTTDconfig::getContent()));
  ...
  $page->setLanguage(LANG)
      ...
      ->setTitle('Goodflow OpenTTD creator')
      ->addBody($content);
