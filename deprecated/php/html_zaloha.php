...
//TODO pridat systemovy atribut: visible => buse se starat o skryvani html prvku
    ...
    public function setText($text) {
      if (is_array($text)) {
        ...
        //TODO malicko jinak s rpipojovanim textu!!!!
      } else {
        $this->text[] = $text;
        $this->content[] = array('type' => 'text', 'content' => $text);
      }
      return $this;
    }
        ...
        if (is_array($elements)) {
          foreach ($elements as $elem) {
            if ($elem instanceof Html) {
              ...
              $this->children[] = $elem;
              $this->content[] = array('type' => 'html', 'content' => $elem); //TODO implementovat!!!
          ...
          if ($elements instanceof Html) {
            ...
            $this->content[] = array('type' => 'html', 'content' => $elements);
