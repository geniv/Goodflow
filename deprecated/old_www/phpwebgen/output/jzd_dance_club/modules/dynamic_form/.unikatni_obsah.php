<?php
  ...
  $result = array("admin_menu" => array(array("main_href" => "%%1%%",
                                              "odkaz" => "Administrace dynamickeho fomulare",
    ...
    <fieldset>
      <dl>\n",
                  ...
                  "normal_vypis_form_optgroup_kon_1" => "\n            </optgroup>",
      ...
      <p id=\"centralni_form_dodatek\">%%1%%</p>
                  ...
                  "normal_email_send_complet_1" => "data odeslána... %%1%%%%2%%",

                  "normal_input_error_1" => "chyba vstupnich dat!",

                  "admin_vstupni_typ_select_begin" => "<select name=\"vstupni_typ\">",
      ...
      ",
                  ...
                  "admin_typ_select_begin" => "<select name=\"typ\"%%1%%>",
          ...
          ",
            ...
            ",
                ...
                ",
                  ...
                  "admin_add_elem_nazev" => "nazev: <input type=\"text\" name=\"nazev\" value=\"%%1%%\" />%%2%%<br />",

                  "admin_add_elem_name" => "name: <input type=\"text\" name=\"name\" />%%1%%<br />",
                  ...
                  "admin_add_elem_min_poc" => "min_poc: <input type=\"text\" name=\"min_poc\" /><br />",

                  "admin_add_elem_max_poc" => "max_poc: <input type=\"text\" name=\"max_poc\" /><br />",
                ...
                <form method=\"post\">
                  <fieldset>
                    ...
                    %%8%%
                    %%9%%
                    zacatek: <input type=\"checkbox\" name=\"zacatek\"%%10%% /><br />
                    %%11%%
                    %%12%%
                    %%13%%
                    %%14%%
                    %%15%%
                    %%16%%
                    poradi: <input type=\"text\" name=\"poradi\" value=\"%%17%%\" />*>0<br />
                ...
                ",
                  ...
                  "admin_edit_elem_name" => "name: <input type=\"text\" name=\"name\" value=\"%%1%%\" />%%2%%<br />",
              ...
              <form method=\"post\">
                <fieldset>
                  formulář: %%1%%<br />
                  %%2%%, po uložení vyplnit dané políčka<br />
                  %%3%%
                  %%4%%
                  %%5%%
                  input_class: <input type=\"text\" name=\"input_class\" value=\"%%6%%\" /><br />
                  input_id: <input type=\"text\" name=\"input_id\" value=\"%%7%%\" />%%8%%<br />
                  input_akce: <input type=\"text\" name=\"input_akce\" value=\"%%9%%\" /><br />
                  %%10%%
                  %%11%%
                  %%12%%
                  %%13%%
                  zacatek: <input type=\"checkbox\" name=\"zacatek\"%%14%% /><br />
                  %%15%%
                  %%16%%
                  %%17%%
                  %%18%%
                  %%19%%
                  %%20%%
                  poradi: <input type=\"text\" name=\"poradi\" value=\"%%21%%\" />*>0<br />
