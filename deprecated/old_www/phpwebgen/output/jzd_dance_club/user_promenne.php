 ...
 */
  ...
  class UserPromenne extends LoginMySQLi
  {
    ...
    public $admin_expire_sec = 0; //expirace sekund
    public $admin_expire_min = 30; //expirace minut
    public $admin_expire_hod = 0; //expirace hodin
    ...
    public $nazevwebu = "JZD Dance club";  //definuje nazev webu
    ...
    public $htaccess = false;  //true/false - zapinani adres pro htaccess
