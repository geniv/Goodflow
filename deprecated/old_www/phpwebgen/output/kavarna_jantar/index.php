...
*/
  function __construct()
  {
    if (file_exists($this->fileprom) && file_exists($this->filefunc))
    {
      ...
      $slovo = $this->var->main[0]->NactiFunkci("CaptchaCode", "GenerujNahodneSlovo", 1); //pro id 1
      $captcha = $this->var->main[0]->NactiFunkci("CaptchaCode", "CaptchaKod", 1, $slovo);  //pro id 1 se slovem
...
//var_dump($this->var->main[0]->NactiFunkci("Funkce", "ExistenceUrl", "http://seznam.cz"));
      ...
      $flash1 = $this->var->main[0]->NactiFunkci("DynamicZobrazeni", "DynamickeZobrazeni", "adresa1");
