...
if ($_GET["action"] == "logout")
{
  ...
  header("Location: http://geniv-laptop/");
}

if ($_SERVER["PHP_AUTH_USER"] != $root && $_SERVER["PHP_AUTH_PW"] != $pass)
{
  ...
  else
{
  if ($_SERVER["PHP_AUTH_USER"] == $root && $_SERVER["PHP_AUTH_PW"] == $pass)
  {
    ...
    <div align=\"left\">
      <table border=\"0\" width=\"100%\" height=\"19\">
        ...
        <span class=\"headd\"><strong><big>&nbsp; The AppServ Open Project - "._APPVERSION." "._FOR." Linux </big> <a href=\"?action=logout\">Odhlásit se</a></strong></span></font></td>
        </tr>
      </table>
    ...
    <div align=\"left\">
      <table width=\"100%\" border=\"0\">
        <tr bgcolor=\"#FFF9FD\">
          <td height=\"344\">
            <blockquote>
              <p><font color=\"#000080\"><span class=\"headd\">
                <strong><br>
                  <img src=\"appserv/members.gif\" width=\"20\" height=\"20\" align=\"absmiddle\">
                    <span class=\"app\">
                      <a href=\""._LPHPMYADMIN."/\">"._PHPMYADMIN." "._VERSION." "._VPHPMYADMIN."</a>
                      <br />
                      <img src=\"appserv/members.gif\" width=\"20\" height=\"20\" align=\"absmiddle\">
                      <a href=\"SQLiteManager/\">SQLite Manager 1.2.0 CZ</a>
                      <br>
                      <img src=\"appserv/annoicon.gif\" width=\"20\" height=\"20\" align=\"absmiddle\">
                      <a href=\"phpinfo.php\">"._PHPINFO." "._VERSION." "._VPHP."</a>
                      <br>
                </strong>
                    </span>
                  </font>
    ...
    else
  {
    header("WWW-Authenticate: Basic realm=\"localhost\"");
    header("HTTP/1.0 401 Unauthorized");
    echo "bohužel se musíte přihlásit";
  }
}
?>
