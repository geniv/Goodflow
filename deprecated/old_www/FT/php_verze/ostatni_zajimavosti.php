...
<table border=1 align=center valign=top cellspacing=3 cellpadding=3 borderColorDark=white borderColorLight=white style="border-left-color:black; border-bottom-color:black; border-top-color:black; border-right-color:black;">
 ...
 <tr>
  ...
  <td><input type=image src="obr_zajimavosti/obr_nahled/obr_zajimavosti_k.gif" onclick="location.href='obr_zajimavosti/obr_zajimavosti/obr_zajimavosti_k.jpg'"></td>
  <td><input type=image src="obr_zajimavosti/obr_nahled/obr_zajimavosti_l.gif" onclick="location.href='obr_zajimavosti/obr_zajimavosti/obr_zajimavosti_l.jpg'"></td>
 </tr>
</table>
<table border=0 align=center valign=top cellspacing=0 cellpadding=0>
 <tr>
