...
{$prikaz="<a href=\"index.php?kam=$kam&cislo=$i\" class=\"odkaz\">Smazat</a>";}
else
{$prikaz="Nelze smazat!";}
//{$udaj[($i*$del)-1]}
print
...
unlink("foto_{$cislo}_qowiifhnisvjnsofvnisfcnoadihcnidfjnvoiadhviosfjfiweuhnvjsoiddfhnisdvjodfhviujdffvisujhcvqiecnviedjwfnvijwednviuqedfbv.php");
if (File_Exists("../".$slozka."/miniatury")) RmDir("../$slozka/miniatury");
if (File_Exists("../".$slozka)) rmdir("../$slozka");
