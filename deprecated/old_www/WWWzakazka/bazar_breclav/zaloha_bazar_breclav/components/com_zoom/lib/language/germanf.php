...
|                                                                     |
-----------------------------------------------------------------------
* @version $Id: germanf.php,v 1.12 2006/12/17 23:32:17 kevinuru Exp $
...
define ('_ZOOM_INSTALL_MESS2','HINWEIS: Die erste Sache die Sie tun sollten, ist im Men&uuml; "Components" nach dem Eintrag <br> "zOOm Media Gallery" zu schauen und es anzuklicken.<br>Stellen Sie dann unter "Einstellung" alles nach Ihren Bed&uuml;rfnissen ein.');
...
define ('_ZOOM_INSTALL_MESS_FAIL3','Wenn Sie diese Verzeichnisse erstellt haben, gehen Sie zu <br /> "Components -> zOOm Media Gallery" und &auml;ndern die Einstellungen f&uuml; sich ab.');
?>