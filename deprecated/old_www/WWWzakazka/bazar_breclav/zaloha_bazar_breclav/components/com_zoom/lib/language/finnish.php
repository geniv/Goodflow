...
| License: GPL                                                        |
|					                                                  |
| Filename: finnish.php, version 18.12.2006                           |
| Finnish language file for Zoom Gallery 2.5.1 RC3 build 20061217 (week 50b)                      |
| Creator: Finnish Joomla translation team		                      |
|          Mikko Mustalampi, mikko@planeetta.net                      |
| Updates to 2.5.1 RC3 by Sami Haaranen, restores@re-stores.com       |
...
define("_ZOOM_THUMB", "Zoom pikkukuvien koodit");
define("_ZOOM_THUMB_DESCR", "Muodosta helpoosti Zoom pikkukuvien koodit");
...
define("_ZOOM_HD_HIDEMSG","Piilota 'ei kuvia' teksti");
...
define("_ZOOM_SETTINGS_OVERRIDE_FFMPEG","Käytä Ffmpeg-asetuksta vaikka zOOm ei löydä sitä järjestelmästä.");
...
define("_ZOOM_SETTINGS_CATIMG","Näytä Kategorian Kuva");
...
define("_ZOOM_SETTINGS_LASTSUBM","Näytä \"Last Submitted Media\" linkki etusivulla");
...
define("_ZOOM_SETTINGS_CLOSE","Näytä \"Close\" linkki popup-ikkunassa");
...
define("_ZOOM_SETTINGS_MEDIAFOUND","Näytä \"Media Found\" teksti galleriassa");
define("_ZOOM_SETTINGS_ANONYMOUS_COMMENTS","Salli nimettömät kommentit");
define("_ZOOM_SETTINGS_WM_ENABLE_TITLE","Ota toiminto käytttöön");
define("_ZOOM_SETTINGS_WM_TITLE", "Vesileimat");
...
define("_ZOOM_MOVEFILES","Siirrä kuvia");
define("_ZOOM_BUTTON_MOVE","Siirrä");
define("_ZOOM_MOVEFILES_STEP1","Askel 1: Valitse lähdegalleria");
define("_ZOOM_ALERT_MOVE","%s kuva siirretty, %s kuvaa ei voitu siirtää.");
...
define("_ZOOM_CREDITS","Tietoja zOOm Mediagalleriasta ja tekijätiedot");
...
define("_ZOOM_UPLOAD_DRAGNDROP","Vedä ja Pudota (Drag n' Drop)");
...
define("_ZOOM_BUTTON_UPLOAD","Siirä palvelimelle");
...
define("_ZOOM_CONFIRM_DEL","VAROITUS!\\n Tämä valinta poistaa gallerian kokonaan, mukaanlukien tiedostot.\\n\\n Haluatko jatkaa?");
...
define("_ZOOM_ALERT_NODELPIC","Kuvaa ei voitu poistaa!");
...
define("_ZOOM_ALERT_UPLOADOK","Kuvan siirto onistui!");
...
define("_ZOOM_ALERT_TOOBIG","Meidian tiedostokoko on liian suuri; %s on suurin sallittu koko."); //added 08-08-2006
...
define("_ZOOM_ALERT_IMGFOUND","kuva(a) löytyi.");
...
define("_ZOOM_INFO_PROCESSING","Käsitellään kuvaa:");
...
define("_ZOOM_IMAGES","kuva(a)");
define("_ZOOM_IMGFOUND","löytyi - olet sivulla");
...
define("_ZOOM_COMMENTS","Kommentit");
...
define("_ZOOM_PASS_BUTTON","Jatka");
...
define("_ZOOM_EXIF_SHOWHIDE","Näytä/Piilota EXIF-tiedot");
...
define ('_ZOOM_INSTALL_MESS2','HUOM: Ensimmäiseksi sinun tulee tarkistaa asetukset <br>komponenttivalikon "zOOm Media Gallery Admin" kohdasta, napsaut sitä<br> ja valitse asetukset-sivu Ylläpitojärjestelmästä.');
