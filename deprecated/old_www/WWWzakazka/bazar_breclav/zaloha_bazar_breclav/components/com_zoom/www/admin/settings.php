...
|                                                                     |
-----------------------------------------------------------------------
* @version $Id: settings.php,v 1.36 2006/12/23 04:30:19 kevinuru Exp $
* @package zOOmGallery
...
if ($action == 'wipe'){
    ...
    $zoom->wipeZoom();
    $imgdir = $mosConfig_absolute_path. "/images/zoom";
    $zoom->delete_directory($imgdir);
    @mkdir ($mosConfig_absolute_path."/images/zoom", 0777);
    @mkdir ($mosConfig_absolute_path."/images/zoom/watermarks", 0777);
	@$zoom->platform->chmod($mosConfig_absolute_path."/images/zoom", '0777');
    @$zoom->platform->chmod($mosConfig_absolute_path."/images/zoom/watermarks", '0777');
	@$zoom->platform->copy($mosConfig_absolute_path."/components/com_zoom/www/images/zoom_logo_faded.png", $mosConfig_absolute_path."/images/zoom/watermarks/zoom_logo_faded.png");
}
...
<form enctype="multipart/form-data" name="adminForm" method="post" action="<?php echo ($zoom->_isBackend) ? "index2.php" : sefReltoAbs("index.php?option=com_zoom&page=settings");?>">
  <div class="tab-page" id="modules-cpanel">
    ...
    <div class="tab-page" id="module22">
	...
	if (strlen($zoom->_CONFIG['safemodeversion']) > 0) {
	?>
    <div class="tab-page" id="module24" align="center">
	...
	?>
    <div class="tab-page" id="module25">
      <h2 class="tab"><?php echo _ZOOM_SETTINGS_TAB7;?></h2>
      <script language="javascript" type="text/javascript">
			<!--
      ...
      <br />
    	  ...
    	  <div class="tab-page" id="module26">
      <h2 class="tab"><?php echo _ZOOM_SETTINGS_TAB8;?></h2>
      <script language="javascript" type="text/javascript">
			<!--
			tabPane1.addTabPage( document.getElementById( "module26" ) );
			//-->
		</script>
      <table border="0" cellpadding="3" cellspacing="0">
        <tr>
