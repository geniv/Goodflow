...
|                                                                     |
-----------------------------------------------------------------------
* @version $Id: catsmgr.html.php,v 1.30 2006/12/11 03:52:12 kevinuru Exp $
* @package zOOmGallery
...
class HTML_catsmgr {
    function headers($live_site) {
        ...
        <link href="'.$live_site.'/components/com_zoom/www/xTree/dhtmlXTree.css" type="text/css" rel="stylesheet" media="screen" />
        <script language="javascript" type="text/javascript" src="'.$live_site.'/includes/js/dhtml.js"></script> 	
        <link id="luna-tab-style-sheet" type="text/css" rel="stylesheet" href="'.$live_site.'/components/com_zoom/www/tabs/tabpane.css" />
        <script language="javascript" type="text/javascript" src="'.$live_site.'/components/com_zoom/www/tabs/tabpane.js"></script>
        <script language="javascript" type="text/javascript" src="'.$live_site.'/components/com_zoom/lib/js/prototype.js"></script>
        <script language="javascript" type="text/javascript" src="'.$live_site.'/components/com_zoom/lib/js/scriptaculous.js?load=button,effects,dhtmlXCommon,dhtmlXTree,dragdrop,mm,tjpzoom"></script>
        ');
        if (false) {
...
<div class="tab-page" id="catsmgr_tabs">
	    <script language="javascript" type="text/javascript">
			<!--
			var tabPane1 = new WebFXTabPane( $( "catsmgr_tabs" ), 0 )
			//-->
		</script>
	    <div class="tab-page" id="catsmgr_tabs_page1">
		<h2 class="tab"><?php echo _ZOOM_ITEMEDIT_TAB1;?></h2>
		<script language="javascript" type="text/javascript">
			<!--
			tabPane1.addTabPage( $( "catsmgr_tabs_page1" ) );
			//-->
		</script>
	...
	<tr>
        ...
        <div class="tab-page" id="catsmgr_tabs_page2">
		<h2 class="tab"><?php echo _ZOOM_ITEMEDIT_TAB2;?></h2>
		<script language="javascript" type="text/javascript">
			<!--
			tabPane1.addTabPage( $( "catsmgr_tabs_page2" ) );
			//-->
		</script>
		...
		<div class="tab-page" id="catsmgr_tabs_page3">
		<h2 class="tab"><?php echo _ZOOM_ITEMEDIT_TAB3;?></h2>
		<script language="javascript" type="text/javascript">
			<!--
			tabPane1.addTabPage( $( "catsmgr_tabs_page3" ) );
			//-->
		</script>
		<table border="0" width="300" cellpadding="4">
		<tr>
