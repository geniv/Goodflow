...
function editConfiguration($option)
{
	...
	HTML_adsmanager::editConfiguration($option, $rows[0],$cb_fields);
}
...
function editField($option) {
	...
	$sort_direction[] = mosHTML::makeOption( 'DESC', _CMN_SORT_DESC );
	$sort_direction[] = mosHTML::makeOption( 'ASC', _CMN_SORT_ASC );
