 ...
 */
  ...
  {
    $result =
    "<a href=\"?{$this->var->get_kam}={$this->var->adresaadminu}&amp;{$this->var->get_idmodul}={$this->idmodul}\" title=\"\">administrace dynamickeho fomulare</a><br />";
        ...
        case "test_rv":
          ...
          <form method=\"post\">
            <fieldset>
              ...
              vstup: <input type=\"input\" name=\"vstup\" value=\"{$vstup}\" /><br />
              reg_exp: <input type=\"input\" name=\"reg_exp\" value=\"{$reg_exp}\" /><br />
        ...
        case "addform": //pridavani formulare
          ...
          <form method=\"post\">
            <fieldset>
              ...
              nazev: <input type=\"input\" name=\"nazev\" /><br />
              predmet: <input type=\"input\" name=\"predmet\" />*<br />
              ...
              odesilatel admin: <input type=\"input\" name=\"odesilateladmin\" id=\"id_odesilatel\" /><br />
              email: <input type=\"input\" name=\"email\" />*<br />
              text email: <input type=\"input\" name=\"textemail\" />*<br />
              dodatek: <input type=\"input\" name=\"dodatek\" /><br />
              oznameni: <input type=\"checkbox\" name=\"oznameni\" checked=\"checked\" /><br />
              predmet oznameni: <input type=\"input\" name=\"predmetoznameni\" /><br />
              odesilatel uzivatel: <input type=\"input\" name=\"odesilateluzivatel\" />*<br />
              text email oznameni: <input type=\"input\" name=\"textemailoznameni\" /><br />
              zdrojovy email: <input type=\"input\" name=\"zdrojovyemail\" />(name elementu)<br />
            ...
            if ($res->numRows() == 1)
            {
              ...
              <form method=\"post\">
                <fieldset>
                  ...
                  nazev: <input type=\"input\" name=\"nazev\" value=\"{$data->nazev}\" /><br />
                  predmet: <input type=\"input\" name=\"predmet\" value=\"{$data->predmet}\" />*<br />
                  ...
                  odesilatel admin: <input type=\"input\" name=\"odesilateladmin\" id=\"id_odesilatel\" value=\"{$data->odesilateladmin}\" /><br />
                  email: <input type=\"input\" name=\"email\" value=\"{$data->email}\" />*<br />
                  text email: <input type=\"input\" name=\"textemail\" value=\"{$data->textemail}\" />*<br />
                  dodatek: <input type=\"input\" name=\"dodatek\" value=\"{$data->dodatek}\" /><br />
                  oznameni: <input type=\"checkbox\" name=\"oznameni\"".($data->oznameni ? " checked=\"checked\"" : "")." /><br />
                  predmet oznameni: <input type=\"input\" name=\"predmetoznameni\" value=\"{$data->predmetoznameni}\" /><br />
                  odesilatel uzivatel: <input type=\"input\" name=\"odesilateluzivatel\" value=\"{$data->odesilateluzivatel}\" />*<br />
                  text email oznameni: <input type=\"input\" name=\"textemailoznameni\" value=\"{$data->textemailoznameni}\" /><br />
                  zdrojovy email: <input type=\"input\" name=\"zdrojovyemail\" value=\"{$data->zdrojovyemail}\" />(name elementu)<br />
              ...
              if ($res->numRows() == 1)
              {
                ...
                <form method=\"post\">
                  <fieldset>
                    ...
                    ".($show_nazev ? "nazev: <input type=\"input\" name=\"nazev\" value=\"{$data->nazev}\" />".($text_hint ? $this->znakdoporuc : "")."<br />" : "")."
                    ".(!Empty($num_input[$data->typ][3]) ? "name: <input type=\"input\" name=\"name\" />".($submit_hint || $text_hint ? $this->znakdoporuc : "")."<br />" : "")."
                    ".(!Empty($num_input[$data->typ][4]) && Empty($num_input[$data->typ][9]) ? "value: <input type=\"input\" name=\"value\" />".($submit_hint ? $this->znakdoporuc : "")."<br />" : "")."
                    input_class: <input type=\"input\" name=\"input_class\" /><br />
                    input_id: <input type=\"input\" name=\"input_id\" /><br />
                    input_akce: <input type=\"input\" name=\"input_akce\" /><br />
                    ...
                    ".(!Empty($num_input[$data->typ][10]) ? "reg_exp: <input type=\"input\" name=\"reg_exp\" /><a href=\"http://php.net/manual/en/regexp.reference.php\">dokumentace</a><br />" : "")."
                    ".(!Empty($num_input[$data->typ][10]) ? "min_poc: <input type=\"input\" name=\"min_poc\" /><br />" : "")."
                    ".(!Empty($num_input[$data->typ][10]) ? "max_poc: <input type=\"input\" name=\"max_poc\" /><br />" : "")."
                    poradi: <input type=\"input\" name=\"poradi\" value=\"{$this->PocetRadku($form)}\ />*>0<br />
            ...
            if ($res->numRows() == 1)
            {
              ...
              <form method=\"post\">
                <fieldset>
                  ...
                  ".($show_nazev ? "nazev: <input type=\"input\" name=\"nazev\" value=\"{$data->nazev}\" />".($text_hint ? $this->znakdoporuc : "")."<br />" : "")."
                  ".(!Empty($num_input[$data->typ][3]) ? "name: <input type=\"input\" name=\"name\" value=\"{$data->name}\" />".($submit_hint || $text_hint ? $this->znakdoporuc : "")."<br />" : "")."
                  ".(!Empty($num_input[$data->typ][4]) && Empty($num_input[$data->typ][9]) ? "value: <input type=\"input\" name=\"value\" value=\"{$data->value}\" />".($submit_hint ? $this->znakdoporuc : "")."<br />" : "")."
                  input_class: <input type=\"input\" name=\"input_class\" value=\"{$data->input_class}\" /><br />
                  input_id: <input type=\"input\" name=\"input_id\" value=\"{$data->input_id}\" />".($data->label ? $this->znakdoporuc : "")."<br />
                  input_akce: <input type=\"input\" name=\"input_akce\" value=\"{$data->input_akce}\" /><br />
                  ...
                  ".(!Empty($num_input[$data->typ][10]) ? "reg_exp: <input type=\"input\" name=\"reg_exp\" value=\"{$data->reg_exp}\" /><a href=\"http://php.net/manual/en/regexp.reference.php\">dokumentace</a><br />" : "")."
                  ".(!Empty($num_input[$data->typ][10]) ? "min_poc: <input type=\"input\" name=\"min_poc\" value=\"{$data->min_poc}\" /><br />" : "")."
                  ".(!Empty($num_input[$data->typ][10]) ? "max_poc: <input type=\"input\" name=\"max_poc\" value=\"{$data->max_poc}\" /><br />" : "")."
