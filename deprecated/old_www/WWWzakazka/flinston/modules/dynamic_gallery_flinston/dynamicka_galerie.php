 ...
 */
  ...
  {
    $result =
    "<a href=\"?{$this->var->get_kam}={$this->var->adresaadminu}&amp;{$this->var->get_idmodul}={$this->idmodul}\" title=\"\">administrace dynamické obrázkové galerie bez sekcí</a><br />";
        ...
        case "config":  //kofigurace galerie
          ...
          <form method=\"post\">
            <fieldset>
              ...
              width full: <input type=\"input\" name=\"w_full\" id=\"full4_p1\" value=\"0\" disabled /> px<br />
              height full: <input type=\"input\" name=\"h_full\" id=\"full4_p2\" value=\"0\" disabled /> px<br />
              <br />
              <br />
              limit:<br />
        ...
        case "add": //pridavani obrazku
          ...
          <form method=\"post\" enctype=\"multipart/form-data\">
            <fieldset>
              ...
              ".($this->ValueConfig(5) > 2 ? "poradi: <input type=\"input\" name=\"poradi\" /><br />" : "")."
            ...
            if ($res->numRows() == 1)
            {
              ...
              <form method=\"post\" enctype=\"multipart/form-data\">
                <fieldset>
                  ...
                  ".($this->ValueConfig(5) > 2 ? "poradi: <input type=\"input\" name=\"poradi\" value=\"{$data->poradi}\" /><br />" : "")."
