 ...
 */
  ...
  {
    $result =
    "<a href=\"?{$this->var->get_kam}={$this->var->adresaadminu}&amp;{$this->var->get_idmodul}={$this->idmodul}\" title=\"\">administrace datového skladu</a><br />";
      ...
      switch ($co)
      {
        case "adddir": //pridavani slozky
          ...
          <form method=\"post\" enctype=\"multipart/form-data\">
            <fieldset>
              název složky: <input type=\"input\" name=\"slozka\" /><br />
        ...
        case "editdir": //uprava slozky
          ...
          <form method=\"post\" enctype=\"multipart/form-data\">
            <fieldset>
              název složky: <input type=\"input\" name=\"nazev\" value=\"{$base}\" /><br />
