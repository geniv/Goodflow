<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../../../tiny_mce/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../../../tiny_mce/'; // absolute or relative from this script path, required.
        ...
        $mcImageManagerConfig['filesystem.extensions'] = "zip,xvid,xml,xls,xhtml,wmv,wma,wav,vob,vcd,txt,ttf,tiff,tif,tga,swf,rtf,rm,rar,psd,ppt,pps,png,pl,php,pdf,otf,ogg,nrg,mpeg,mpg,mp4,mp3,mov,mds,mdf,swf,js,jpg,jpeg,iso,html,gz,gif,fon,flv,flac,doc,divx,dat,cue,css,cgi,cab,bmp,avi,asp,asf,arj,ape,aiff,ace,aac,7z,3gp";
        ...
        // Upload options
        $mcImageManagerConfig['upload.maxsize'] = "16MB";
        ...
        $mcImageManagerConfig['upload.extensions'] = "zip,xvid,xml,xls,xhtml,wmv,wma,wav,vob,vcd,txt,ttf,tiff,tif,tga,swf,rtf,rm,rar,psd,ppt,pps,png,pl,php,pdf,otf,ogg,nrg,mpeg,mpg,mp4,mp3,mov,mds,mdf,swf,js,jpg,jpeg,iso,html,gz,gif,fon,flv,flac,doc,divx,dat,cue,css,cgi,cab,bmp,avi,asp,asf,arj,ape,aiff,ace,aac,7z,3gp";
