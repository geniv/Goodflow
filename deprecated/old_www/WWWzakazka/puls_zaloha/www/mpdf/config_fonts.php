...
/* Vlastni fonty */
    'arial','arialb','arialbi',
    'arial_black',
    'arial_ce','arial_ceb','arial_cei','arial_ce_bi',
    'courier','courierb',
    'georgia','georgiab','georgiai','georgiabi',
    'helvetica','helveticab',
    'myriad_pro_black','myriad_pro_black_it',
    'myriad_pro_black_cond','myriad_pro_black_cond_it',
    'myriad_pro_black_semi_cn','myriad_pro_black_semi_cn_it',
    'myriad_pro_black_semi_ext','myriad_pro_black_semi_ext_it',
    'myriad_pro_bold','myriad_pro_bold_it',
    'myriad_pro_bold_cond','myriad_pro_bold_cond_it',
    'myriad_pro_bold_semi_cn','myriad_pro_bold_semi_cn_it',
    'myriad_pro_bold_semi_ext','myriad_pro_bold_semi_ext_it',
    'myriad_pro_cond','myriad_pro_cond_it',
    'myriad_pro_regular','myriad_pro_it',
    'myriad_pro_light','myriad_pro_light_it',
    'myriad_pro_light_cond','myriad_pro_light_cond_it',
    'myriad_pro_light_semi_cn','myriad_pro_light_semi_cn_it',
    'myriad_pro_light_semi_ext','myriad_pro_light_semi_ext_it',
    'myriad_pro_semi_bold','myriad_pro_semi_bold_it',
    'myriad_pro_semi_bold_cond','myriad_pro_semi_bold_cond_it',
    'myriad_pro_semi_bold_semi_cn','myriad_pro_semi_bold_semi_cn_it',
    'myriad_pro_semi_bold_semi_ext','myriad_pro_semi_bold_semi_ext_it',
    'myriad_pro_semi_cn','myriad_pro_semi_cn_it',
    'myriad_pro_semi_ext','myriad_pro_semi_ext_it',
    'tahoma','tahoma_bold',
    'times_bold','times_bold_italic',
    'times_ce_regular',
    'times_new_roman','times_new_romanb','times_new_romani','times_new_romanbi',
    'trebuchet_ms','trebuchet_msb','trebuchet_msi','trebuchet_msbi',
    'verdana','verdanab','verdanai','verdanabi',
    'perpetua','perpetuab','perpetuai','perpetuabi',
    'dali',
