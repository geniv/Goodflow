...
if (!Empty($_COOKIE["R_jmeno"]) and !Empty($_COOKIE["R_heslo"]) and !Empty($_COOKIE["R_ID"]) and LogAdmin(".", $_COOKIE["R_jmeno"], $_COOKIE["R_heslo"], 0) == "true1" and LoginVzkazy(".", $_COOKIE["R_jmeno"], $_COOKIE["R_heslo"], $_COOKIE["R_ID"]) == "true1")
{
  ...
  <tr>
    <td align=\"center\" class=\"sekce_nadpis\">Outdoor ceník</td>
  </tr>
  <tr>
    <td align=\"center\" height=\"10px\"></td>
  </tr>
  ...
  <tr>
    <td align=\"center\" class=\"sekce_text\">V této sekci naleznete odkaz na aktuální ceník v outdoor sekci.</td>
  </tr>
  <tr>
    <td align=\"center\" height=\"10px\"></td>
  </tr>
  <tr>
    <td align=\"center\" class=\"sekce_text\">Jestli chcete vyměnit aktuální ceník za nový, tak nahrajte nový ceník do složky <u>Upload</u> pomocí FTP manažera.</td>
  </tr>
  <tr>
    <td align=\"center\" height=\"10px\"></td>
  </tr>
  <tr>
    <td align=\"center\" class=\"sekce_text\">Jakmile nahrajete nový ceník do složky <u>Upload</u>, tak přejděte do sekce <a href=\"index.php?kam=soubory\">Soubory&nbsp;z&nbsp;FTP</a> a další pokyny naleznete tam.</td>
  </tr>
</table>
<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\" width=\"100%\">
  <tr>
...
<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\" width=\"1%\">
  <tr>
    <td align=\"center\">Aktuální&nbsp;ceník&nbsp;sekce&nbsp;outdoor:</td>
    <td align=\"center\">&nbsp;&nbsp;</td>
    <td align=\"center\"><a href=\"../cenik_outdoor.doc\">stáhnete&nbsp;zde</a></td>
  </tr>
</table>
...
";
  ...
  if (!Empty($tlupload) and !Empty($soubor))
  {
    ...
    $destination_file="../cenik_outdoor.doc";
    ...
    else
    {
      ...
      Soubor aktualizován! Pokračuj <a href=\"index.php?kam=out\">zde</a>";
    }
    ftp_close($conn_id);
  }
    else
  {
    if (!Empty($tlupload))
    {
      ...
      Není vybraný žádný soubor! Pokračuj <a href=\"index.php?kam=out\">zde</a>";
    }
  }
  */
}
