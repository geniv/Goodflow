<?
$soub="kadernictvi/administrace/cenik_sjfhvboiklkasjcoiqpfjjhfgdfkdlsjcvkdjfbvhireuhgviurehvhnuf.php";
$u=fopen($soub,"r");
$cen=explode("--CEN--",fread($u,DelkaOtevirani("kadernictvi/administrace")));
fclose($u);
...
{
print 
"<h4>Ceník služeb kadeønictví:</h4>
...
<td height=\"20px\" align=\"center\" width=\"31%\">{$cen[($i*$del)]},- Kè</td>
</tr>";
}//end for
print 
"</table><br>";
