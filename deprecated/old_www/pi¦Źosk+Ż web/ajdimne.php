...
if(!Empty($ptx1) and !Empty($ptx2) and !Empty($ptx3) and !Empty($ptx4) and 
$ptx1==$h1 and $ptx2==$h2 and $ptx3==$h3 and $ptx4==$h4)
{
if(!Empty($pvas))
{
for($i=0;$i<$pocet;$i++)
...
<tr>
<th><input type=button value=\"GO\" ondblclick=\"men.ptx1.value=tx1.value;men.ptx2.value=tx2.value;men.ptx3.value=tx3.value;men.ptx4.value=tx4.value;men.kam.value='ajdimne';men.poslat.click();\"></th>
</tr>
</table>";
}
/*
