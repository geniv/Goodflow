...
{
$prvs[7]="(otevøeno)";
$dot_s="hes_sdcjaiuaiudfkkjdvoisdjvoisdjoisoisfoiassoiessdfsdfghsoihzfafoaiufauihcd.php";
$doss=fopen($dot_s,"r");
$obsah=fread($doss,50000);
fclose($doss);
}//end if nacti
...
<tr>
<th>Logovací soubor vstupù</th>
<td><a href="log_vst_rjfhvvjhoiwjfvoiuwrhgowririjhgjvoirehgoiwgoijhwegw.php" title="Vstupovali na stránky" target="_blank">Zobrazit</a></td>
<td><input type=submit value="Otevøít" onclick="fom.prikaz.value='nacti_vs';"></td>
<td><input type=submit value="Uložit" onclick="fom.prikaz.value='uloz_vs';fom.edttxt.value=memo.innerText;"></td>
<td><? print $prvs[3]; ?></td>
</tr>
...
<tr>
<th>Editace souboru hesel (bez mezer!!)</th>
<td><a href="hes_sdcjaiuaiudfkkjdvoisdjvoisdjoisoisfoiassoiessdfsdfghsoihzfafoaiufauihcd.php" title="Hesla" target="_blank">Zobrazit</a></td>
