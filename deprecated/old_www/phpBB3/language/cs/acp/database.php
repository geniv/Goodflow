...
$lang = array_merge($lang, array(
	...
	'ACP_RESTORE_EXPLAIN'	=> 'Spustí kompletní obnovu všech tabulek phpBB z uloženého souboru. Podporuje-li to váš server, můžete použít text komprimovaný ve formátu gzip nebo bzip2, který bude automaticky dekomprimován. <strong>UPOZORNENÍ</strong> Tato akce přepíše všechna existující data. Obnova může trvat déle, vyčkejte proto prosím na této stránce, dokud nebude ukončena. Zálohy budou uloženy v adresári <samp>store/</samp> a budou pokládány za zálohy vytvořené pomocí systému phpBB. Obnovené zálohy, které nebyly tímto systémem vytvořeny, nemusí být funkční.',
