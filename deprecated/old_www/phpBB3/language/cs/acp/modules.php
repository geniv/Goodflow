...
$lang = array_merge($lang, array(
	'ACP_MODULE_MANAGEMENT_EXPLAIN'	=> 'Zde můžete spravovat všechny druhy modulů. Berte na vědomí, že Ovládací panely mají tří-stupňovou strukturu (Kategorie -> Kategorie -> Modul) , kdežto ostatní mají 2-stupňovou strukturu (Kategorie -> Modul), která musí být dodržena. Upozorňujeme vás, že se můžete odříznout od ovládání, pokud vypnete nebo smažete samotný modul, starající se o správu modulů.',
