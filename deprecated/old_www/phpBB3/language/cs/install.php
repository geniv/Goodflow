...
$lang = array_merge($lang, array(
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Nyní jste úspěšně převedli vaše fórum na verzi phpBB 3.0. Nyní se můžete přihlásit pro <a href="../">přístup na vaše fórum</a>. Dříve než smažete složku install/ a zapnete své fórum, zkontrolujte, jestli všechna data byla úspěšně přenesena. Mějte na vědomí, že podpora phpBB je dostupná na internetu přes <a href="http://www.phpbb.com/support/documentation/3.0/">Uživatelský manuál</a> a <a href="http://www.phpbb.com/phpBB/viewforum.php?f=46">fórum podpory</a>',
	'CONVERT_INTRO'				=> 'Vítejte v phpBB - Univerzální Konvertovací Framework',
	'CONVERT_INTRO_BODY'		=> 'Odsud můžete importovat data z jiných (instalovaných) systému pro fóra. Seznam níže uvádí všechny nyní dostupné moduly pro přechod. Pokud konvertor z verze, který hledáte není na seznamu, zkuste navštívit naše stránky, kde další moduly mohou být ke stažení.',
  ...
  'COULD_NOT_COPY'			=> 'Nelze zkopírovat soubor <strong>%1$s</strong> do <strong>%2$s</strong><br /><br />Zkontrolujte jestli cílová složka existuje a je zapisovatelná',
	...
	'DB_PORT_EXPLAIN'			=> 'Vyplňujte jen když víte, že db server používá nestandardní port',
	...
	'DEV_NO_TEST_FILE'			=> 'Nebyla zadaná žádná hodnota pro proměnnou test_file v konvertoru. Pokud jste uživatel tohoto konvertoru, měli byste toto nahlásit autorovi tohoto modulu. Pokud jste autor tohoto modulu, musíte specifikovat soubor, který existuje v zdrojovém fóru, pro ověření cesty k němu.',
	...
	'INSTALL_NEXT_PASS'			=> 'Všechny základní zkoušky byli úspěšné a můžete pokračovat na další krok instalace. Pokud jste změnili jakékoliv oprávnění, moduly atd. můžete je nyní nastavit zpět, pokud si přejete.',
	...
	'INST_ERR_DB_NO_SQLITE'		=> 'Verze rozšíření SQLite, kterou máte nainstalovanou, je příliš zastaralá, je potřeba ji aktualizovat nejméně na verzi 2.8.2.',
  ...
  'SYNC_POST_COUNT_ID'		=> 'Synchronizuji počty příspěvků od <var>záznamu</var> %1$s do %2$s.',
	...
	'TABLE_PREFIX_SAME'			=> 'Předpona tabulek musí být stejná jako je použitá softwarem z kterého převádíte fórum.<br />» Zvolená předpona tabulek byla %s',
...
$lang = array_merge($lang, array(
  ...
  'COMPLETE_LOGIN_TO_BOARD'		=> 'Nyní byste se měli <a href="../ucp.php?mode=login">přihlásit na fórum</a> a zkontrolovat jestli vše funguje jak má. Nezapomeňte smazat, přesunout nebo přejmenovat vaší instalační složku!',
	...
	'CURRENT_FILE'					=> 'Začátek současného původního souboru',
	...
	'DIFF_SEP_EXPLAIN'					=> 'Konec současného původního souboru / Začátek nově aktualizovaného souboru',
	...
	'FILES_NEW_EXPLAIN'				=> 'Následující soubory zatím neexistují ve vaší instalaci. Budou do ni během aktualizace přidány.',
	...
	'INCOMPATIBLE_UPDATE_FILES'		=> 'Aktualizační soubory nejsou kompatibilní s vaší instalovanou verzí. Vy máte nainstalovanou verzi %1$s a soubory jsou určeny pro převod z phpBB %2$s na %3$s.',
  ...
  'MERGING_FILES_EXPLAIN'      => 'Právě shromažďuji konečné úpravy souborů.<br /><br />Prosíme vyčkejte, než phpBB dokončí všechny úpravy na změněných souborech.',

	'NEW_FILE'						=> 'Konec nového aktualizovaného souboru',
  ...
  'NUMBER_OF_FILES_COLLECTED'      => 'Současně mám rozdíly o %1$d z %2$d shromážděných souborů.<br />Prosím vyčkejte dokončení shromáždění souborů.',
  ...
  'TOGGLE_DISPLAY'         => 'Zobrazit/skrýt seznam souborů',
	...
	',
	'UPDATE_METHOD'					=> 'Metoda aktualizace',
