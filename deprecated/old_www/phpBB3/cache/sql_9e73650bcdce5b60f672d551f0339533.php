...
/* SELECT image_name, image_filename, image_lang, image_height, image_width FROM phpbb_styles_imageset_data WHERE imageset_id = 1 AND image_lang IN ('cs', '') */

$expired = (time() > 1207837039) ? true : false;
if ($expired) { return; }
