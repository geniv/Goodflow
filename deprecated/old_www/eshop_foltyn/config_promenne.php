 ...
 */
  ...
  class ConfigPromenne extends UserPromenne //promenne zdedi promenne z UserPromenne
  {
    ...
    public $klenot = false;  //true/false - nastaveni jestli je domena na klenot.cz ci ne
    public $autoklenot = false;  //true/false - (zapnuto / vypnuto auto zjistovani) - zjitsti podle IP jestli je soubor na webu si nikoli
