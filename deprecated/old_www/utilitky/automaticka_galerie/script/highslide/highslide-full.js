...
lang : {
	cssDirection: 'ltr',
	loadingText : 'Nahr·v·m...',
	loadingTitle : 'Klikni pro stornov·nÌ',
	focusTitle : 'Klikni pro p¯esunutÌ do pop¯edÌ',
	fullExpandTitle : 'ZvÏtöit do skuteËnÈ velikosti (f)',
	creditsText : '',
	creditsTitle : '',
	previousText : 'P¯edchozÌ',
	nextText : 'DalöÌ', 
	moveText : 'P¯esunout',
	closeText : 'Zav¯Ìt', 
	closeTitle : 'Zav¯Ìt (esc)', 
	resizeTitle : 'ZvÏtöit / zmenöit obr·zek',
	playText : 'Spusù',
	playTitle : 'Spusù slideshow (mezernÌk)',
	pauseText : 'Pauza',
	pauseTitle : 'Zapauzuj slideshow (mezernÌk)',
	previousTitle : 'P¯edchozÌ (öipka doleva)',
	nextTitle : 'DalöÌ (öipka doprava)',
	moveTitle : 'P¯esunout obr·zek',
	fullExpandText : 'Pln· velikost',
	number: 'Obr·zek %1 z %2',
	restoreTitle : 'KliknutÌm zav¯ete obr·zek, kliknutÌm a p¯etaûenÌm m˘ûete obr·zek posunovat po str·nk·ch. Pouûijte öipky pro dalöÌ a p¯edchozÌ obr·zek.'
},
