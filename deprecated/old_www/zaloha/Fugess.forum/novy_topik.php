<?
/*
<span  class="nav"><a href="index.php" class="nav">Obsah fóra Fugessovo fórum</a>
-> <a href="viewforum.php?f=1" class="nav">Struèný popis fóra</a></span>

typ pøevodu textu:

$text="slùvkkfm [b] dkùfjn [/b] dflkbdlkbmlk"; //1

$vys=str_replace("[b]","<b>",$text); //1do2
$vys1=str_replace("[/b]","</b>",$vys); //2do3
...
<form  method="post" name="post">
                  ...
                  <td class="cBarStart" valign="top">
                    <table border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td class="cattitle"><span class="cattitle"><b>Pøidat nové téma</b></span></td>
                      </tr>
                    </table>
                  </td>
                  ...
                  <td class="cBoxStart">
                    ...
                    <table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
                              ...
                              <td colspan="9">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td nowrap align="right"><span class="gen"><a href="javascript:bbstyle(-1)" class="genmed" onMouseOver="helpline('a')">zavøít znaèky</a></span></td>
                                  </tr>
                                </table>
                      ...
                      <tr>
                        ...
                        <input type="radio" name="topictype" value="0" checked="checked"> Normální&nbsp;&nbsp;
                        <input type="radio" name="topictype" value="1"> Dùležité&nbsp;&nbsp;
                        <input type="radio" name="topictype" value="2"> Oznámení&nbsp;&nbsp;
                        </span></td>
                      </tr>
  ...
  <tr>
    ...
    <td width="100%" class="mainBox" cellpadding="0">
			...
			<tr>
				<th class="thHead" colspan="2">Pøidat hlasování</th>
	                </tr>
                </table>
...
-->
            ...
            <td width="100%" class="mainBox" cellpadding="0">
		      ...
		      <tr>
                        <td class="catBottom" colspan="2" align="right" height="28">
                          <span class="gensmall"><span class="bottom">Èasy uvádìny v GMT + 1 hodina</span></span>
                        </td>
                      </tr>
                    </table>
  ...
  <input type="hidden" name="kam" value="<? print $kam; ?>">
...
{
print 
"pøedmìt: <b>$subject</b><br>
zpráva: <b>$message</b><br>
typ: <b>$topictype</b><br>";
print "Upravený vzhled: ".prekopej_text($message);
