...
$u=fopen($soub,"r");
$pozn=explode("--PZ--",fread($u,10000000));
fclose($u);
//-------------------------------------------------------
...
"                     <table width=\"100%\" border=\"0\" cellspacing=\"8\" style=\"padding-left: 5px\">
                            ...
                            <A href=\"viewforum.php?f=1&...dodìlat!\" class=\"forumlink\">{$tema[$pom-1]}</a>
                            <BR>
                            </span>
...
<td><span class="genmed">Uživatelé zaslali celkem <b>6809</b> pøíspìvkù.<BR/>Je zde <b>87</b> registrovaných uživatelù.<BR/>Nejnovìjším registrovaným uživatelem je <b><a href="profile.php?mode=viewprofile&amp;u=89">seqwence</a></b>.</span></td>
</tr>
<tr>
<td class="onlineIndex"><span class="genmed">Celkem je zde pøítomno <b>3</b> uživatelù: 0 registrovaných, 0 skrytých a 3 anonymních. &nbsp; [ <span style="color:#27CFFF">administrátoøi</span> ] &nbsp; [ <span style="color:#FFFF00">moderátoøi</span> ]<BR/>Nejvíce zde bylo souèasnì pøítomno <b>43</b> uživatelù dne so leden 13, 2007 10:15 am.<BR/>Registrovaní uživatelé: nikdo není pøítomen</span></td>
</tr>
</table>
