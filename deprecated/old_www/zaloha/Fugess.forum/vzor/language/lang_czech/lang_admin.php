...
$lang['Welcome_phpBB'] = 'Vítej v administraci fóra';
$lang['Admin_intro'] = 'Tato stránka slouží k rychlému zobrazení různých statistik tohoto fóra. Pokud se budeš chtít vrátit zpět na tuto stránku, tak klikni na odkaz <u>Obsah administrace</u> v levém panelu. Pro návrat na obsah tohoto fóra, klikni na logo fóra umístěném též v levém panelu. Ostatní odkazy v levém panelu této stránky Tě dovedou k jednotlivým položkám možného nastavení fóra dle tvých požadavků, každá stránka obsahuje návod jak použít danou funkci.';
