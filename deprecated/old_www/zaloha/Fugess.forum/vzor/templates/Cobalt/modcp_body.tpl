          ...
          <tr>
            <td class="ErrorConfirmBoxStart">
				  ...
				  <table width="100%" cellpadding="4" cellspacing="1" border="0">
					...
					<tr> 
					  <th width="70%" colspan="2" nowrap>&nbsp;{L_TOPICS}&nbsp;</th>
					  <th width="10%" nowrap>&nbsp;{L_REPLIES}&nbsp;</th>
					  <th width="20%" nowrap>&nbsp;{L_LASTPOST}&nbsp;</th>
					  <th width="25" class="thRight" nowrap>&nbsp;{L_SELECT}&nbsp;</th>
					</tr>
					<!-- BEGIN topicrow -->
					<tr> 
					  <td width="25" class="row1" align="center" valign="middle"><img src="{topicrow.TOPIC_FOLDER_IMG}" width="23" height="23" alt="{topicrow.L_TOPIC_FOLDER_ALT}" title="{topicrow.L_TOPIC_FOLDER_ALT}" class="img_topicstatus" /></td>
					  <td width="70%" class="row1">&nbsp;<span class="topictitle">{topicrow.TOPIC_TYPE}<a href="{topicrow.U_VIEW_TOPIC}" class="topictitle">{topicrow.TOPIC_TITLE}</a></span></td>
					  <td width="10%" class="row2" align="center" valign="middle"><span class="postdetails">{topicrow.REPLIES}</span></td>
					  <td width="20%" class="row1" align="center" valign="middle"><span class="postdetails">{topicrow.LAST_POST_TIME}</span></td>
					  <td width="25" class="row2" align="center" valign="middle"> 
