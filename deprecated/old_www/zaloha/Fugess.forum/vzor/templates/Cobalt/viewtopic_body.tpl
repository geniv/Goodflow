								...
								<td class="{postrow.ROW_CLASS}" width="80%" height="28" valign="top">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td valign="top" align="right" nowrap="nowrap">{postrow.QUOTE_IMG} {postrow.EDIT_IMG} {postrow.DELETE_IMG} {postrow.IP_IMG} <a href="#top"><img src="templates/Cobalt/images/icon_top.gif" width="22" height="19" alt="Přesunout pohled nahoru" border="0" class="imgfade" onmouseover="this.className='imgfull'" onmouseout="this.className='imgfade'"></a></td>
										</tr>
										<tr> 
