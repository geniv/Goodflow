...
if($st=="true")
{
SetCookie("Jmeno_r",$uziv,Time()+360000);
SetCookie("Heslo_r",$hesl,Time()+360000);
}//end if st=true

}//end if empty
//odpocet(Date("s"));dořešit!

//if(!Empty($Jmeno_r) and !Empty($Heslo_r))//dořešit!
//{
