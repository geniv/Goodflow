...
<head>
     ...
     <title><?php echo get_settings('blogname'); ?> - Komentář k <?php the_title(); ?></title>
...
<?php foreach ($comments as $comment) { ?>
	...
	<p><cite><?php comment_type('Komentář', 'Trackback', 'Pingback'); ?> by <?php comment_author_link() ?> &#8212; <?php comment_date() ?> @ <a href="#comment-<?php comment_ID() ?>"><?php comment_time() ?></a></cite></p>
...
<form action="<?php echo get_settings('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
	...
	<p>
	  ...
	  <input type="text" name="url" id="url" value="<?php echo $comment_author_url; ?>" size="28" tabindex="3" />
	   ...
	   <label for="url"><acronym title="Jednotný zdrojový identifikátor">URI</acronym></label>
	...
	<p>
	  ...
	  <input name="submit" type="submit" tabindex="5" value="Řekněte to! " />
...
<p>Promiňte, ale komentáře jsou nyní uzamčeny, zkuste to později.</p>
...
<div><strong><a href="javascript:window.close()">Zavři okno.</a></strong></div>
...
<p class="credit"><?php timer_stop(1); ?> <cite>Poháněno <a href="http://www.starcraftii.cz" title="Poháněno WordPress, state-of-the-art semantic personal publishing platform"><strong>Wordpress</strong></a></cite></p>

<?php // Seen at http://www.starcraftii.cz/ ?>
