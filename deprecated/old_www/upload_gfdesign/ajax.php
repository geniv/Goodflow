...
*/
        ...
        case "css": //get - vykreslovani global styles
          $style = $_GET["style"];
          settype($style, "integer");
          $result = $this->var->main->ViewCSS($style);
        break;

        case "listingshare":  //post - vypis sdileni
          $result = $this->var->main->AjaxVypisUzivateluSdileni();
        break;

        case "setshare":  //post - nastaveni jednotlivych slozek
          $result = $this->var->main->AjaxNastaveniSdileni();
        break;
