<?
if(!Empty($message) and !Empty($ID_uz))
{
if(!Empty($poz) and Empty($upr) and !Empty($ID_uz))
{print uloz_upraveny_prispevek($cis,$pris,stripslashes($subject),stripslashes($message),$Jmeno_r,$ID_uz,$topictype,$REMOTE_ADDR,$poz,$str);}
else
{
if(Empty($subject)){$subject="";}
print pridat_novy_prispevek($cis,$pris,stripslashes($subject),stripslashes($message),$Jmeno_r,$ID_uz,$topictype,$REMOTE_ADDR,$str);
}//end if poz
}
else
{print 
                      ...
                      <td class=\"cBarStart\" valign=\"top\">
                        <table border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
                          <tr>
                            ...
                            <td class=\"cattitle\"><span class=\"tableTitle\">Nevyplnily jste text zprávy</span></td>
                          </tr>
                        </table>
                      </td>
                    ...
                    <tr>
                      <td class=\"cBoxStart\">
                        <table width=\"80%\" cellspacing=\"3\" cellpadding=\"2\" border=\"0\" align=\"center\">
                          ...
                          <tr>
                            <td align=\"center\"><span class=\"genmed\"><b>Napište text zprávy pro odeslání pøíspìvku.</b></span></td>
                          </tr>
                          <tr>
                            <td align=\"center\">&nbsp;</td>
                          </tr>
