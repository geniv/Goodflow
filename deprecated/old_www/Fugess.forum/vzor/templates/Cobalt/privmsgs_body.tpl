          ...
          <tr> 
            <td class="privmsgsBoxStart">
              <table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
                <tr> 
                  <th width="25" height="25" class="thCornerL" nowrap>&nbsp;{L_FLAG}&nbsp;</th>
                  <th width="60%" class="thTop" nowrap>&nbsp;{L_SUBJECT}&nbsp;</th>
                  <th width="25%" class="thTop" nowrap>&nbsp;{L_FROM_OR_TO}&nbsp;</th>
                  <th width="15%" class="thTop" nowrap>&nbsp;{L_DATE}&nbsp;</th>
                  <th width="25" class="thCornerR" nowrap>&nbsp;{L_MARK}&nbsp;</th>
                </tr>
                <!-- BEGIN listrow -->
                <tr> 
                  <td class="{listrow.ROW_CLASS}" width="25" align="center" valign="middle"><img src="{listrow.PRIVMSG_FOLDER_IMG}" width="23" height="23" alt="{listrow.L_PRIVMSG_FOLDER_ALT}" title="{listrow.L_PRIVMSG_FOLDER_ALT}" class="img_pmstatus" /></td>
                  ...
                  <td width="25" align="center" valign="middle" class="{listrow.ROW_CLASS}"><span class="postdetails"> 
