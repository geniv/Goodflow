...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  <tr> 
	<th width="25%"  height="25" class="thCornerL">{L_STATISTIC}</th>
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  ...
  <!-- END reg_user_row -->
  <tr> 
	<td colspan="5" height="1" class="row3"><img src="../templates/Cobalt/images/spacer.gif" width="1" height="1" alt="."></td>
  </tr>
