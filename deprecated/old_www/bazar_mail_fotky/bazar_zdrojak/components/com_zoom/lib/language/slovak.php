...
|                                                                     |
-----------------------------------------------------------------------
* @version $Id: slovak.php,v 1.2 2006/12/17 23:32:17 kevinuru Exp $
...
define("_ZOOM_PICK","Vybraù galÈriu");
define("_ZOOM_DELETE","Vymazaù");
define("_ZOOM_BACK","Nasp‰ù");
define("_ZOOM_MAINSCREEN","Hlavn· str·nka");
define("_ZOOM_BACKTOGALLERY","Nasp‰ù do galÈrie");
...
define("_ZOOM_SETTINGS_SLIDESHOW","Prezent·cia");
...
define("_ZOOM_SLIDESHOW","Prezent·cia:");
define("_ZOOM_PREV_IMG","dozadu");
define("_ZOOM_NEXT_IMG","dopredu");
define("_ZOOM_FIRST_IMG","prv˝");
define("_ZOOM_LAST_IMG","posledn˝");
define("_ZOOM_PLAY","prehraù prezent·ciu");
define("_ZOOM_STOP","zastaviù prehr·vanie");
define("_ZOOM_RESET","reset");
define("_ZOOM_FIRST","Prv˝");
define("_ZOOM_LAST","Posledn˝");
define("_ZOOM_PREVIOUS","Predch·dzaj˙ci");
define("_ZOOM_NEXT","Nasleduj˙ci");
define("_ZOOM_IN_DESC", "Kurzorom myöi uk·ûte na obr·zok a pomocou öÌpiek nastavte mieru jeho zv‰Ëöenia.");

//Gallery actions
define("_ZOOM_SEARCH_BOX","Prehæad·vaù galÈrie");
define("_ZOOM_ADVANCED_SEARCH","RozöÌrenÈ vyhæad·vanie");
define("_ZOOM_SEARCH_KEYWORD","Hæadaù pomocou kæ˙Ëov˝ch slov");
define("_ZOOM_IMAGES","obr·zkov");
define("_ZOOM_IMGFOUND","bolo n·jden˝ch %s obr·zkov - ste na strane %s z %s");
define("_ZOOM_SUBGALLERIES","pod-galÈrie");
define("_ZOOM_ALERT_COMMENTOK","V·ö koment·r bol ˙speöne pridan˝!");
define("_ZOOM_ALERT_COMMENTERROR","Tento obr·zok ste uû okomentovali!");
define("_ZOOM_ALERT_VOTE_OK","V·ö hlas bol zapoËÌtan˝. œakujeme");
define("_ZOOM_ALERT_VOTE_ERROR","Za tento obr·zok ste uû hlasovali.");
define("_ZOOM_WINDOW_CLOSE","Zavrieù");
define("_ZOOM_NOPICS","GalÈria je pr·zdna");
define("_ZOOM_PROPERTIES","Vlastnosti");
define("_ZOOM_COMMENTS","Koment·r");
define("_ZOOM_NO_COMMENTS","V diskusii k tomuto obr·zku nie s˙ pridanÈ ûiadne koment·re.");
define("_ZOOM_YOUR_NAME","Vaöe meno");
define("_ZOOM_ADD","Pridaù");
define("_ZOOM_NAME","N·zov");
define("_ZOOM_DATE","D·tum pridania");
define("_ZOOM_UNAME","Pridal");
define("_ZOOM_DESCRIPTION","Popis");
define("_ZOOM_IMGNAME","N·zov");
define("_ZOOM_FILENAME","N·zov s˙boru");
define("_ZOOM_CLICKDOCUMENT","(kliknite na n·zov s˙boru a otvorte dokument)");
define("_ZOOM_KEYWORDS","Kæ˙ËovÈ slov·");
define("_ZOOM_HITS","videnÌ");
define("_ZOOM_CLOSE","Zavrieù");
define("_ZOOM_NOIMG", "Nebolo niË n·jdenÈ!");
define("_ZOOM_NONAME", "MusÌte zadaù meno!");
define("_ZOOM_NOCAT", "Nebola vybran· ûiadna galÈria!");
define("_ZOOM_EDITPIC", "Editovaù");
define("_ZOOM_SETCATIMG","Nastaviù ako popisn˝ obr·zok galÈrie");
define("_ZOOM_SETPARENTIMG","Nastaviù ako popisn˝ obr·zok MATERSKEJ galÈrie.");
define("_ZOOM_PASS","Heslo");
define("_ZOOM_PASS_REQUIRED","Pre prÌstup k tejto galÈrii potrebujete heslo.<br />ProsÌm vyplÚte polÌËko heslo<br />a stlaËte tlaËidlo Vst˙più. œakujeme.");
define("_ZOOM_PASS_BUTTON","Vst˙più");
define("_ZOOM_PASS_GALLERY","Heslo");
define("_ZOOM_PASS_INNCORRECT","Nespr·vne heslo");

//Hotlinking
define("_ZOOM_SETTINGS_HOTLINK","Zapn˙ù ochranu proti Hotlinkovaniu");
define("_ZOOM_SETTINGS_HPTOOLTIP","Ak je zapnut· ochrana proti Hotlinkovaniu, s˙ cesta k s˙boru a jeho n·zov skrytÈ. Ak sa niekto pok˙si o nalinkovanie obr·zka na in˙ str·nku, tento sa na nej nezobrazÌ.");


//Lightbox
define("_ZOOM_LIGHTBOX","Lightbox");
define("_ZOOM_LIGHTBOX_GALLERY","Uloûiù t˙to galÈriu do Lightboxu!");
define("_ZOOM_LIGHTBOX_ITEM","Uloûiù tento obr·zok do Lightboxu!");
define("_ZOOM_LIGHTBOX_VIEW","Pozrieù Lightbos");
define("_ZOOM_YOUR_LIGHTBOX","Obsah V·öho Lighboxu:");
define("_ZOOM_LIGHTBOX_EMPTY","V·ö Lightbox je pr·zdny.");
define("_ZOOM_LIGHTBOX_ZIPBTN","Vytvoriù ZIP-s˙bor");
define("_ZOOM_LIGHTBOX_PLAYLISTBTN","Vytvoriù Playlist &amp; Prehraù");
define("_ZOOM_LIGHTBOX_CATS","GalÈrie");
define("_ZOOM_LIGHTBOX_TITLEDESCR","Titul &amp; Popis");
define("_ZOOM_ACTION","Akcia");
define("_ZOOM_LIGHTBOX_ADDED","Poloûka bola ˙speöne pridan· do V·öho Lightboxu!");
define("_ZOOM_LIGHTBOX_NOTADDED","T·to poloûka uû bola do V·öho Lightboxu pridan·!");
define("_ZOOM_LIGHTBOX_EDITED","Poloûka bola ˙speöne zmenen·!");
define("_ZOOM_LIGHTBOX_NOTEDITED","Chyba pri zmene poloûky!");
define("_ZOOM_LIGHTBOX_DEL","Poloûka bola ˙speöne odstr·nen· z V·öho Lightboxu!");
define("_ZOOM_LIGHTBOX_NOTDEL","Pri odstraÚovanÌ poloûky z Lightboxu sa vyskytla chyba!");
define("_ZOOM_LIGHTBOX_NOZIP","ZIP s˙bor bol uû vytvoren˝. Lightbox neobsahuje ûiadne poloûky!");
define("_ZOOM_LIGHTBOX_PARSEZIP","Parsujem obr·zky z galÈrie...");
define("_ZOOM_LIGHTBOX_DOZIP","vytv·ram s˙bor ZIP...");
define("_ZOOM_LIGHTBOX_DLHERE","Teraz si mÙûete stiahnuù obsah Lightboxu");
define("_ZOOM_LIGHTBOX_PLSUCCESS","Playlist bol ˙speöne vytvoren˝. ProsÌm obnovte okno prehr·vaËa.");
define("_ZOOM_LIGHTBOX_PLERROR","Chyba pri tvorbe Playlistu.");
define("_ZOOM_LIGHTBOX_NOAUDIO","NajskÙr musÌte do Lightboxu pridaù zvukov˝ s˙bor!");
define("_ZOOM_LIGHTBOX_NOITEMS","Lightbox je pr·zdny.");

//EXIF information
define("_ZOOM_EXIF","EXIF");
define("_ZOOM_EXIF_SHOWHIDE","Uk·zaù/Skryù Metadata");

//MP3 id3 v1.1 or later information
define("_ZOOM_AUDIO_PLAYING","teraz prehr·vam:");
define("_ZOOM_AUDIO_CLICKTOPLAY","Pre prehranie tohto s˙boru kliknite sem.");
define("_ZOOM_ID3","ID3");
define("_ZOOM_ID3_SHOWHIDE","Uk·zaù/Skryù ID3-tag data");
define("_ZOOM_ID3_LENGTH","DÂûka");
define("_ZOOM_ID3_QUALITY","Kvalita");
define("_ZOOM_ID3_TITLE","N·zov");
define("_ZOOM_ID3_ARTIST","Interpret");
define("_ZOOM_ID3_ALBUM","Album");
define("_ZOOM_ID3_YEAR","Rok");
define("_ZOOM_ID3_COMMENT","Koment·r");
define("_ZOOM_ID3_GENRE","é·ner");

//Video metadata information
define("_ZOOM_VIDEO_SHOWHIDE","Uk·zaù/Skryù Video data");
define("_ZOOM_VIDEO_PIXELRATIO","RozlÌöenie px");
define("_ZOOM_VIDEO_QUALITY","Kvalita obrazu");
define("_ZOOM_VIDEO_AUDIOQUALITY","Kvalita zvuku");
define("_ZOOM_VIDEO_CODEC","Codec");
define("_ZOOM_VIDEO_RESOLUTION","RozlÌöenie");

//rating
define("_ZOOM_RATING","Hodnotenie");
define("_ZOOM_NOTRATED","NehodnotenÈ!");
define("_ZOOM_VOTE","hlas");
define("_ZOOM_VOTES","hlasov");
define("_ZOOM_RATE0","odpad");
define("_ZOOM_RATE1","slabÈ");
define("_ZOOM_RATE2","priemer");
define("_ZOOM_RATE3","dobrÈ");
define("_ZOOM_RATE4","veæmi dobrÈ");
define("_ZOOM_RATE5","perfektnÈ!");

//special
define("_ZOOM_TOPTEN","10 najlepöie hodnoten˝ch");
define("_ZOOM_LASTSUBM","PridanÈ ako poslednÈ");
define("_ZOOM_LASTCOMM","OkomentovanÈ ako poslednÈ");
define("_ZOOM_SEARCHRESULTS","V˝sledky vyhæad·vania");
define("_ZOOM_TOPRATED","Najlepöie hodnotenÈ");

//ecard
define("_ZOOM_ECARD_SENDAS","Poslaù priateæovi ako virtu·lnu pohæadnicu!");
define("_ZOOM_ECARD_YOURNAME","Vaöe meno");
define("_ZOOM_ECARD_YOUREMAIL","V·ö email");
define("_ZOOM_ECARD_FRIENDSNAME","Meno priateæa");
define("_ZOOM_ECARD_FRIENDSEMAIL","Email priateæa");
define("_ZOOM_ECARD_MESSAGE","Text odkazu");
define("_ZOOM_ECARD_SENDCARD","Poslaù");
define("_ZOOM_ECARD_SUCCESS","Vaöa pohæadnica bola ˙speöne odoslan·.");
define("_ZOOM_ECARD_CLICKHERE","Pre jej zobrazenie kliknite sem!");
define("_ZOOM_ECARD_ERROR","Pri posielanÌ pohæadnice vznikla chyba. Pohæadnica bola poslan· adres·tovi");
define("_ZOOM_ECARD_TURN","Pozrite sa na zadn˙ stranu pohæadnice!");
define("_ZOOM_ECARD_TURN2","Pozrite sa na predn˙ stranu pohæadnice!");
define("_ZOOM_ECARD_SENDER","PoslanÈ:");
define("_ZOOM_ECARD_SUBJ","Dostali ste virtu·lnu pohæadnicu od:");
define("_ZOOM_ECARD_MSG1","V·m poslal virtu·lnu pohæadnicu z");
define("_ZOOM_ECARD_MSG2","Kliknite na link niûöie a pozrite si Vaöu virtu·lnu pohæadnicu!");
define("_ZOOM_ECARD_MSG3","ProsÌm neodpovedajte na tento mail/upozornenie. Jedn· sa o automaticky generovan˝ email.");
define("_ZOOM_ECARD_ECARDEXPIRED","Je n·m æ˙to, ale t·to pohæadnica uû nie je k dispozÌcii, alebo vypröal Ëas jej platnosti.");
