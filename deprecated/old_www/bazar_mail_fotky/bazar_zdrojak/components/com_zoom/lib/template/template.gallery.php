...
|                                                                     |
-----------------------------------------------------------------------
* @version $Id: template.gallery.php,v 1.21 2006/12/23 06:36:33 kevinuru Exp $
* @package zOOmGallery
...
class ZMG_Template_Gallery {
        ...
        if ($use_tables) {
            ...
            if ($show_search) {
                ...
                <div class="zoom-search">	
                    ...
                    <input type="submit" value="<?php echo _ZOOM_PASS_BUTTON ?>" class="button" />
                    </form>
                </div>
                <?php
            }
    ...
    function showGalleryListButton($use_tables = true, $Itemid, &$gallery, $no_columns, $gallery_prefix, $show_catimg, $show_metabox) {
        ...
        if ($use_tables) {
            ...
            if ($show_catimg) {
                ?>
                <td align="left" valign="top" width="<?php echo number_format((100/$no_columns), 0, '.', ''); ?>%"><a href="<?php echo sefRelToAbs("index".$backend.".php?option=com_zoom&amp;Itemid=".$Itemid."&amp;catid=".$gallery->_id);?>" <?php echo ($show_metabox) ? "onmouseover=\"return overlib('".$img_num." "._ZOOM_IMAGES.$subcat_html."', CAPTION, '".str_replace("&", "&#38;", addslashes($gallery->_name))."');\" onmouseout=\"return nd();\"" : "";?>>
                ...
                ?>
                <td align="left" valign="top" width="50%"><a href="<?php echo sefRelToAbs("index".$backend.".php?option=com_zoom&amp;Itemid=".$Itemid."&amp;catid=".$gallery->_id);?>" <?php echo ($show_metabox) ? "onmouseover=\"return overlib('".$img_num." "._ZOOM_IMAGES.$subcat_html."', CAPTION, '".str_replace("&", "&#38;", addslashes($gallery->_name))."');\" onmouseout=\"return nd();\"" : "";?>>
                <?php
            }
            ...
            if ($show_catimg) {
                ...
                <a href="<?php echo sefRelToAbs("index".$backend.".php?option=com_zoom&amp;Itemid=".$Itemid."&amp;catid=".$gallery->_id);?>" <?php echo ($show_metabox) ? "onmouseover=\"return overlib('".$img_num." "._ZOOM_IMAGES.$subcat_html."', CAPTION, '".str_replace("&", "&#38;", addslashes($gallery->_name))."');\" onmouseout=\"return nd();\"" : "";?>>
    ...
    function showSubGalleryListButton($use_tables = true, $Itemid, &$subgallery, $no_columns, $gallery_prefix, $show_catimg, $show_metabox) {
        ...
        if ($use_tables) {
            ...
            if ($show_catimg) {
                ...
                <a href="<?php echo sefRelToAbs("index".$backend.".php?option=com_zoom&amp;Itemid=".$Itemid."&amp;catid=".$subgallery->_id); ?>" <?php echo ($show_metabox) ? "onmouseover=\"return overlib('".$img_num." "._ZOOM_IMAGES.addslashes($subcat_html)."', CAPTION, '".addslashes($subgallery->_name)."');\" onmouseout=\"return nd();\"" : "";?>>
    ...
    function showMediumListButton($use_tables = true, $Itemid, $PageNo, $counter, $columnwidth, &$size, &$inforow, &$image) {
        ...
        if ($use_tables) {
        	if ($zoom->_CONFIG['showMetaBox']) {
    			$link = "<a onmouseover=\"return overlib('".str_replace("&", "&amp;", $descr)."', CAPTION, '".str_replace("&", "&amp;", $image->_name)."');\" onmouseout=\"return nd();\"";
    		} else {
    			$link = "<a";
    		}
        } else {
            if ($zoom->_CONFIG['showMetaBox']) {
			    $link = "<div class=\"img-shadow\"><a onmouseover=\"return overlib('".str_replace("&", "&amp;", $descr)."', CAPTION, '".str_replace("&", "&amp;", $image->_name)."');\" onmouseout=\"return nd();\"";
    		} else {
