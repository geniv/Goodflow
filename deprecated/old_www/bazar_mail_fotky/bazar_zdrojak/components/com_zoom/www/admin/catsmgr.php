...
|                                                                     |
-----------------------------------------------------------------------
* @version $Id: catsmgr.php,v 1.53 2006/12/23 04:30:19 kevinuru Exp $
* @package zOOmGallery
...
<script language="Javasript" type="text/javascript">
  ...
  function catsmgrStart() {
    if (Zoom && $('cats_tree') && $('toolbar') && $('members_buttons')) {
...
<tr>
<td align="right">
    <div align="right" id="toolbar"></div>
</td>
</tr>
</table>
	...
	<td id="cats_tree_table">
	   <span id="cats_tree_caption">
	       ...
	       <a href="javascript:void(0);" onmousedown="resetFormValues()">
	       		...
	       		<img src="<?php echo $mosConfig_live_site;?>/components/com_zoom/www/xTree/page.gif" id="new" border="0" alt="" />
		   </a>
	   </span>
	   <div id="cats_tree_container">
	   <div id="cats_tree">Loading...</div>
	   </div>
	</td>
	<td id="cats_edit">
        <?php
