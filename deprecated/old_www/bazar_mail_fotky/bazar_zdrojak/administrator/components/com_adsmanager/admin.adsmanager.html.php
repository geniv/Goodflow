...
function editConfiguration($option,$row,$cb_fields)
{
...
$configtabs->startTab("AdsManager","adsmanager-page");
?>
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
	<tr>
		<td>
	...
	<tr>
		...
		<div align="center"><script type="text/javascript"><!--
			google_ad_client = "pub-7426951407254765";
			google_ad_width = 125;
			google_ad_height = 125;
			google_ad_format = "125x125_as_rimg";
			google_cpa_choice = "CAAQ3bWazgEaCIDpU7OcSSWsKJ_D93M";
			google_ad_channel = "0901693454";
			//--></script>
	    ...
	    <td>
		<?php echo ADSMANAGER_ADSENSE; ?>
		</td>
		
	</tr>
	<tr>
		<?php /*echo ADSMANAGER_CHANGE_DEVICE;*/ ?>
	</tr>
</table>
<?php   
$configtabs->endTab();
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
	...
	<tr>
		...
		<td><?php editorArea( 'editor1', "$row->rules_text" , 'rules_text', '100%;', '350', '75', '20' ) ; ?></td>
		<td></td>
	</tr>
</table>
...
<tr>
	...
	<tr>
		...
		<td><?php editorArea( 'editor1',  "$row->recall_text" , 'recall_text', '100%;', '350', '75', '20' ) ; ?></td>
		<td></td>
	</tr>
</table>   
<?php
