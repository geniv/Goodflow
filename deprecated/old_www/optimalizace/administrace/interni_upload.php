...
ftp_close($conn_id);
print "Pøidán soubor: <b>$nazev</b> <a href=\"index.php?kam=interni_upload\">Pokraèuj zde</a>";
}
...
{
//------------------------------------------------------------
$smazat="<a href=\"$aktualni_soubor?kam=interni_upload&prik=smaz&co=$pol/{$cesta[$i]}\">Smazat</a>";
//------------------------------------------------------------
...
echo
"<tr>
<td><a href=\"$pol/{$cesta[$i]}\" target=\"_blank\">{$cesta[$i]}</a></td>
<td>$link</td>
<td>$velikost</td>
<td>$smazat</td>
</tr>";
