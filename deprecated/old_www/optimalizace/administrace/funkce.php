...
function UlozitKonfiguraci($vyska,$sirka,$radku,$sloupcu)
{
  ...
  return "Konfigurace uspìšnì uložena <a href=\"index.php?kam=hlavni\">Pokraèuj zde</a>";
}
//---------------------------------------------------------------------
...
{$kn="<a href=\"index.php?kam=$sekce&cis=$cislo&str=$i\"><u>$i</u></a> ( <a href=\"index.php?kam=$sekce&cis=$cislo&str=$dalstr\" class=\"odkaz\">Další</a> )";} 
} 
}//end for 
...
{$kn1=" ... <a href=\"index.php?kam=$sekce&cis=$cislo&str=$pocet_stran\"><u>$pocet_stran</u></a> ( <a href=\"index.php?kam=$sekce&cis=$cislo&str=$dalstr\" class=\"odkaz\">Další</a> )";} 
 
} 
else 
{ 
if($stranka==$str5) 
{$zc1="$str5, <a href=\"index.php?kam=$sekce&cis=$cislo&str=$str4\"><u>$str4</u></a>, <a href=\"index.php?kam=$sekce&cis=$cislo&str=$pocet_stran\"><u>$pocet_stran</u></a> ( <a href=\"index.php?kam=$sekce&cis=$cislo&str=$dalstr\" class=\"odkaz\">Další</a> )";} 
 
if($stranka==$str4) 
{$zc1="<a href=\"index.php?kam=$sekce&cis=$cislo&str=$str5\"><u>$str5</u></a>, $str4, <a href=\"index.php?kam=$sekce&cis=$cislo&str=$pocet_stran\"><u>$pocet_stran</u></a> ( <a href=\"index.php?kam=$sekce&cis=$cislo&str=$dalstr\" class=\"odkaz\">Další</a> )";} 
...
return "Soubor <b>$nazev</b> byl uspìšnì uložen <a href=\"index.php?kam=pridat_obrazek&galerie=$galerie\">Pokraèuj zde</a>";
}
//---------------------------------------------------------------------
...
return "Odkaz <a href=\"$Link\" target=\"_blank\">$Popis</a> byl uspìšnì uložen <a href=\"index.php?kam=pridat_odkaz\">Pokraèuj zde</a>";
}
//---------------------------------------------------------------------
...
velikost stránek: ".velikost_stranek()."<br>
velikost interného uploadu: ".velikost_adresare("../Upload",true)."
";
