...
//	'ACC_USER_ADMIN'			=> 'User + Admin',
	...
	'MAX_CHARS'					=> 'Max.',
	'MIN_CHARS'					=> 'Min.',
	'MIN_TIME_REG'				=> 'Minimale Zeit für die Registrierung',
	'MIN_TIME_REG_EXPLAIN'		=> 'Das Registrierungsformular kann vor Ablauf dieser Zeit nicht abgesandt werden.',
	'MIN_TIME_TERMS'			=> 'Minimale Zeit für die Bestätigung der Nutzungsbedingungen',
	'MIN_TIME_TERMS_EXPLAIN'	=> 'Die Nutzungsbedingungen können vor Ablauf dieser Zeit nicht bestätigt werden.',
  ...
  'ACC_DATABASE'					=> 'Another database',
  'DUV_LEGEND'            => 'New account verify according foreign database',
  'DUV_SERVER'            => 'Server',
  'DUV_SERVER_EXPLAIN'    => 'Database server, where are saved data about usernames and passwords.',
  'DUV_DBUSER'            => 'Username',
  'DUV_DBUSER_EXPLAIN'    => 'Database username account',
  'DUV_DBPASSWD'          => 'Password',
  'DUV_DBPASSWD_EXPLAIN'  => 'Database password for DB username. WARNING! The password is saved in plain text.',
  'DUV_DATABASE'          => 'Database',
  'DUV_DATABASE_EXPLAIN'  => 'Database, where are saved database table with usernames and passwords.',
  'DUV_DBTABLE'           => 'Table of users',
  'DUV_DBTABLE_EXPLAIN'   => 'Database table with usernames and passwords.',
  'DUV_TA_USER'           => 'Column name of usernames',
  'DUV_TA_USER_EXPLAIN'   => 'The name of column, where are saved usernames.',
  'DUV_TA_PASSWD'         => 'Column name of passwords',
  'DUV_TA_PASSWD_EXPLAIN' => 'The name of column, where are saved passwords.',
  'DUV_TAU_VERIFY'        => 'Username verification',
  'DUV_TAU_VERIFY_EXPLAIN' => 'A method of verification used for usernames.',
  'DUV_TAP_VERIFY'        => 'Password verification',
  'DUV_TAP_VERIFY_EXPLAIN' => 'A method of verification used for passwords.',
  'DUV_COPY'              => 'Transfer next columns',
  'DUV_COPY_EXPLAIN'      => 'Experts only: Enter here column name from local database table, then write \'=\' and a column name from foreign table. Example: user_email=nuke_email, user_icq=nuke_icq, etc.',
  ...
  'DUV_ENCODING'          => 'Texts encoding',
  'DUV_ENCODING_EXPLAIN'  => 'Encoding of texts in foreign database table.',
  'DUV_SEL_LIKE'          => 'LIKE',
  'DUV_SEL_EQUALS'        => '=',
  'DUV_SEL_PLAIN'         => 'Plain text',
  'DUV_SEL_MD5'           => 'Encrypted: MD5',
  'DUV_SEL_OLDPASSWORD'   => 'Encrypted: OLD_PASSWORD',
  'DUV_SEL_PASSWORD'      => 'Encrypted: PASSWORD',
...
$lang = array_merge($lang, array(
	...
	'FORM_TIME_MIN'					=> 'Minimale Zeit zur Übermittlung eines Formulars',
	'FORM_TIME_MIN_EXPLAIN'			=> 'Übermittlungen, die schneller als dieses Limit sind, werden vom Board ignoriert. Um dieses Verhalten abzuschalten, stelle als Wert 0 ein.',
