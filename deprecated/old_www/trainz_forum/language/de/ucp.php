...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'Mit dem Zugriff auf „%1$s“ wird zwischen dir und dem Betreiber ein Vertrag mit folgenden Regelungen geschlossen:</p>
		...
		<li>Die Haftungsbegrenzung der Absätze 1 bis 3 gilt sinngemäß auch zugunsten der Mitarbeiter und Erfüllungsgehilfen des Betreibers.</li>
...
$lang = array_merge($lang, array(
	...
	'AVATAR_EXPLAIN'				=> 'Maximale Bildgröße: %1$d Pixel breit, %2$d Pixel hoch. Maximale Dateigröße: %3$d KiB.',
	...
	// RSS
	'SYNDICATION_METHOD'				=> 'Preferred syndication method',
	'SYNDICATION_ATOM'				=> 'Atom',
	'SYNDICATION_PMS'			=> 'latest PMs of this folder',
	...
	'UCP_ADMIN_ACTIVATE'		=> 'Bitte beachte, dass du eine gültige E-Mail-Adresse angeben musst, bevor dein Benutzerkonto aktiviert wird. Ein Administrator wird dein Benutzerkonto überprüfen und wenn er es freigibt, erhältst du eine Nachricht an die angegebene E-Mail-Adresse.',
 	...
 	// UVD JediSoft.cz
  'ACCOUNT_VERIFIED'			 => 'Thank you for verification of your account. Your account was successfuly transfered to local dastabse. You can login now.',
  'UCP_DATABASE_ACTIVATE'  => 'Enter your username and password what you use for access to main portal.',
  'DUV_INVALID_CONNECTION' => 'Neplatné údaje pro přihlášení k externí databázi. Požádejte administrátora, aby ověřil, že spojení funguje.',
  'DUV_INVALID_DATABASE'   => 'Neplatný název externí databáze. Požádejte administrátora, aby ověřil, že zadal správný název databáze.',
  'DUV_INVALID_QUERY'      => 'Uživatelské jméno a heslo se nepodařilo ověřit, protože dotaz do externí databáze obsahuje neplatné údaje. Požádejte administrátora, aby dotaz prověřil!',
  'DUV_INVALID_UP'         => 'Entered username or password is not on main portal valid. Check if you write your username and password correctly and your account is active.',
