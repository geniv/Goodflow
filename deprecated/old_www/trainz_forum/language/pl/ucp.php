...
*
* @package language
* @version $Id: ucp.php,v 1.136.5 2008/01/18 LEW21 Exp $
...
$lang = array_merge($lang, array(
	...
	<br/>
	Zgadzasz się nie pisać żadnych wypowiedzi o charakterze obraźliwym, oszczerczym, propagującym treści niezgodne z polskim prawem lub naruszających cudze prawa autorskie. Robienie tego może spowodować, że zostaniesz zbanowany na zawsze, a Twój dostawca internetu powiadomiony o Twoim zachowaniu. Zgadzasz się, że „%1$s” ma prawo w każdej chwili usunąć, przeedytować, przenieść lub zamknąć każdy wątek. Zgadzasz się też na zapisywanie wszystkich informacji, które podajesz, w bazie danych. Dane te nie będą przekazywane nikomu bez Twojej zgody, ale ani „%1$s” ani phpBB nie odpowiada za włamania, które mogą spowodować wykradzenie danych.
	',
	...
	<br/>
	Informacje o Tobie są zbierane na dwa sposoby. Po pierwsze, przeglądanie „%1$s” powoduje, że oprogamowanie phpBB tworzy kilka ciasteczek (małych plików tekstowych ściągniętych do katalogu plików tymczasowych na Twoim komputerze). Pierwsze dwa ciasteczka zawierają identyfikator użytkownika (zwany dalej „user-id”) i anonimowy identyfikator sesji (zwany dalej „session-id”), automatycznie przyznane Ci przez oprogramowanie phpBB. Trzecie ciasteczko zostanie utworzone gdy przejrzysz chociaż jeden wątek na „%1$s” i jest używane żeby zapisywać które wątki zostały przeczytane, ułatwiając Ci w ten sposób nawigację po forum.<br/>
	<br/>
...
$lang = array_merge($lang, array(
	...
	'ALLOW_PM_EXPLAIN'				=> 'Zauważ, że admini i moderatorzy zawsze będą mogli wysyłać Ci wiadomości.',
	'ALREADY_ACTIVATED'				=> 'Już aktywowałeś swoje konto.',
	'ATTACHMENTS_EXPLAIN'			=> 'To jest lista załączników, które wysłałeś na forum w swoich postach.',
	'ATTACHMENTS_DELETED'			=> 'Załączniki usunięte.',
	'ATTACHMENT_DELETED'			=> 'Załącznik usunięty.',
	'AVATAR_CATEGORY'				=> 'Kategoria',
	'AVATAR_EXPLAIN'				=> 'Maksymalne rozmiary; szerokość: %1$d pikseli, wysokość: %2$d pikseli, wielkość pliku: %3$d KiB.',
	...
	'BOOKMARKS'					=> 'Zakładki',
	'BOOKMARKS_EXPLAIN'			=> 'Możesz dodać wątki do zakładek, żeby później do nich wrócić. Zaznacz pole obok każdej zakładki, którą chcesz wyrzucić, a następnie naciśnij przycisk <em>Usuń zaznaczone zakładki</em>.',
	'BOOKMARKS_DISABLED'		=> 'Zakładki są zablokowane na tym forum.',
	...
	'DELETE_COOKIES_CONFIRM'		=> 'Czy jesteś pewien, że chcesz usunąć wszystkie Cookies wysłane z tego forum?',
	'DELETE_MARKED_PM'				=> 'Usuń zaznaczone wiadomości',
	'DELETE_MARKED_PM_CONFIRM'		=> 'Czy jesteś pewien, że chcesz usunąć wszystkie zaznaczone wiadomości?',
	...
	'DRAFT_UPDATED'				=> 'Kopia robocza zaktualizowana.',
	...
	'FRIENDS'					=> 'Przyjaciele',
	'FRIENDS_EXPLAIN'			=> 'Zakładka „Przyjaciele” pozwoli Ci mieć szybki dostęp do użytkowników, z którymi często się komunikujesz. Jeśli szablon ma taką możliwość, każdy post napisany przez przyjaciela może być podświetlony.',
	...
	'JOIN_SELECTED'				=> 'Dołącz do zaznaczonych',
	...
	'MESSAGE_REMOVED_FROM_OUTBOX'	=> 'Ta wiadomość została usunięta przez nadawcę zanim została dostarczona.',
	'MESSAGE_SENT_ON'				=> '',
	...
	'NOTIFY_METHOD_EXPLAIN'		=> 'Metoda wysyłania wiadomości wysłanych przez to forum.',
	...
	'NO_AUTH_DELETE_MESSAGE'		=> 'Nie masz prawa do usuwania prywatnych wiadomości.',
	'NO_AUTH_EDIT_MESSAGE'			=> 'Nie masz prawa do edytowania prywatnych wiadomości.',
	'NO_AUTH_FORWARD_MESSAGE'		=> 'Nie masz prawa do przesyłania dalej prywatnych wiadomości.',
	'NO_AUTH_GROUP_MESSAGE'			=> 'Nie masz prawa do wysyłania prywatnych wiadomości do grup.',
	'NO_AUTH_READ_MESSAGE'			=> 'Nie masz prawa do czytania prywatnych wiadomości.',
	'NO_AUTH_READ_REMOVED_MESSAGE'	=> 'Nie możesz przeczytać tej wiadomości, ponieważ została usunięta przez nadawcę.',
	'NO_AUTH_SEND_MESSAGE'			=> 'Nie masz prawa do wysyłania prywatnych wiadomości.',
	'NO_AUTH_SIGNATURE'				=> 'Nie masz prawa do posiadania podpisu.',

	'NO_BCC_RECIPIENT'			=> 'Brak',
	'NO_BOOKMARKS'				=> 'Nie masz zakładek.',
	'NO_BOOKMARKS_SELECTED'		=> 'Nie zaznaczyłeś żadnych zakładek.',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Hasło musi mieć %1$d - %2$d znaki i musi składać się z liter różnej wielkości i cyfr.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'Hasło musi mieć %1$d - %2$d znaki.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Hasło musi mieć %1$d - %2$d znaki i musi składać się z liter różnej wielkości.',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'Hasło musi mieć %1$d - %2$d znaki i musi składać się z liter różnej wielkości, cyfr i symboli.',
	'PASSWORD'					=> 'Hasło',
	'PASSWORD_ACTIVATED'		=> 'Twoje nowe hasło zostało aktywowane.',
	'PASSWORD_UPDATED'			=> 'Twoje hasło zostało wysłane na Twój adres e-mail.',
	...
	'RELEASE_MESSAGES'					=> '%sUwolnij wszystkie czekające wiadomości%s. Zostaną one rozłożone do różnych folderów, jeśli wolna jest odpowiednia ilość miejsca.',
	'REMOVE_ADDRESS'					=> 'Usuń adres',
	'REMOVE_SELECTED_BOOKMARKS'			=> 'Usuń wybrane zakładki',
	'REMOVE_SELECTED_BOOKMARKS_CONFIRM' => 'Czy jesteś pewien, że chcesz usunąć wszystkie zaznaczone zakładki?',
	...
	'RESIGN_SELECTED'					=> 'Opuść zaznaczone',
	...
	'UCP_ADMIN_ACTIVATE'		=> 'Zauważ, że musisz wpisać prawidłowy adres e-mail zanim Twoje konto zostanie aktywowane. Administrator przejrzy Twoje konto i jeśli je zatwierdzi, to dostaniesz e-maila na adres, który podałeś.',
	
		// UVD JediSoft.cz
 'ACCOUNT_VERIFIED'			=> 'Děkujeme za ověření přihlašovacích údajů, váš účet byl vytvořen. Můžete se přihlásit.',
 'UCP_DATABASE_ACTIVATE' => 'Pro ověření zadejte uživatelské jméno a heslo, které používáte při přihlášení do hlavního portálu.',
 ...
 'DUV_INVALID_UP' => 'Vámi zadané uživatelské jméno a heslo není platným účtem na hlavní stránce portálu. Ověřte si, prosím, že jste údaje zadali správně, a že váš účet je aktivní.',

	'UCP_AIM'					=> 'AOL Instant Messenger',
	'UCP_ATTACHMENTS'			=> 'Załączniki',
	'UCP_COPPA_BEFORE'			=> 'Przed %s',
	'UCP_COPPA_ON_AFTER'		=> 'Równo lub po %s',
	'UCP_EMAIL_ACTIVATE'		=> 'Zauważ, że musisz wpisać prawidłowy adres e-mail zanim Twoje konto zostanie aktywowane. Otrzymasz e-maila zawierającego link aktywacyjny na adres, który podałeś.',
	'UCP_ICQ'					=> 'Numer ICQ',
	...
	'UCP_WELCOME'					=> 'Witamy w Panelu Zarządzania Kontem. Możesz stąd monitorować, przeglądać i edytować swój profil, ustawienia, obserwowane działy i wątki. Możesz też wysyłać wiadomości do innych użytkowników (jeśli administracja na to pozwala). Upewnij się, że przeczytałeś ogłoszenia, zanim będziesz kontynuował.',
	...
	'USERNAME_ALPHA_ONLY_EXPLAIN'	=> 'Login musi mieć min. %1$d, a maks. %2$d znaków i składać się tylko z liter alfabetu łacińskiego i cyfr.',
	...
	'USERNAME_LETTER_NUM_EXPLAIN'	=> 'Login musi mieć min. %1$d, a maks. %2$d znaków i składać się tylko z liter i cyfr.',
	...
	'WATCHED_EXPLAIN'			=> 'Poniżej znajduje się lista for i wątków, które obserwujesz. Będziesz informowany o każdym nowym poście w nich napisanym. Żeby przestać obserwować, oznacz forum lub wątek i naciśnij przycisk <em>Przestań obserwować zaznaczone</em>.',
	'WATCHED_FORUMS'			=> 'Obserwowane działy',
	'WATCHED_TOPICS'			=> 'Obserwowane wątki',
	'WRONG_ACTIVATION'			=> 'Klucz aktywacji, który dostarczyłeś, jest nieprawidłowy.',
