...
/**
*
* acp attachments [Polski]
*
* @package language
* @version $Id: attachments.php,v 1.31.1 2007/12/30 Ronnie Exp $
...
$lang = array_merge($lang, array(
	...
	'ACP_EXTENSION_GROUPS_EXPLAIN'		=> 'Tutaj możesz dodawać, usuwać, zmieniać i blokować grupy rozszerzeń. Możesz też przyznawać im specjalne kategorie, zmieniać sposób ściągania czy definiować ikonę wyświetlaną przed załącznikami należącymi do danej grupy.',
	...
	'ATTACH_MAX_PM_FILESIZE_EXPLAIN'	=> 'Maksymalna przestrzeń dysku, jaką mogą zająć załączniki do prywatnych wiadomości wysłane przez każdego użytkownika, 0 to brak limitu.',
	...
	'ATTACH_TO_POST'					=> 'Dołącz do posta',
	...
	'DEFINE_ALLOWED_IPS'			=> 'Zdefiniuj adresy IP / hosty z których wolno ściągać pliki',
	'DEFINE_DISALLOWED_IPS'			=> 'Zdefiniuj adresy IP / hosty z których nie wolno ściągać plików',
	...
	'SECURE_ALLOW_DENY_EXPLAIN'		=> 'Wybierz, czy lista bezpiecznego ściągania ma być listą białą (z wymienionych adresów wolno ściągać pliki) czy czarną (z wymienionych adresów <strong>nie</strong> wolno ściągać plików).',
	'SECURE_DOWNLOADS'				=> 'Włącz bezpieczne ściąganie',
	'SECURE_DOWNLOADS_EXPLAIN'		=> 'Jeśli włączysz tę opcję, ściągać pliki będzie można tylko z podanych przez Ciebie adresów IP / hostów.',
	'SECURE_DOWNLOAD_NOTICE'		=> 'Bezpieczne ściąganie nie jest włączone. Poniższe ustawienia będą działać dopiero po włączeniu tej funkcji.',
	'SECURE_DOWNLOAD_UPDATE_SUCCESS'=> 'Lista adresów IP została zmieniona.',
	'SECURE_EMPTY_REFERRER'			=> 'Pozwól na pustego odsyłającego',
	'SECURE_EMPTY_REFERRER_EXPLAIN'	=> 'Bezpieczne ściąganie bazuje na odsyłających. Czy chcesz pozwolić na ściąganie bez podania odsyłającego?',
