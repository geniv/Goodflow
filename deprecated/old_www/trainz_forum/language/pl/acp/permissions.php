...
*
* @package language
* @version $Id: permissions.php,v 1.38.1 2007/12/23 Ronnie Exp $
...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		<p>System uprawnień w phpBB3 jest bardzo rozbudwany i dlatego został podzielony na 4 główne kategrie:</p>
	...
	'ACL_SET_EXPLAIN'		=> 'Uprawninia bazują na prostym systemie TAK/NIE. Ustawienie opcji na NIGDY nadpisuje wszystie inne wartości jej nadane. Jeżeli nie chcesz nadawać tego uprawnienia, wybierz NIE. Jeżeli gdzieś nadano temu uprawnieniu wartość TAK, zostanie ona użyta zamiast wartości NIE. Wszystkie zaznaczone obiekty użyją tych samych uprawnień, co obiekt, którego uprawnienia ustawiasz.',
	...
	'APPLY_PERMISSIONS_EXPLAIN'	=> 'Uprawnienia ustawione dla tego obiektu zostaną zastosowane do tego obiektu i wszystich zaznaczonych obiektów.',
	...
	'PERMISSION_APPLIED_TO_ALL'		=> 'Uprawnieia zostaną zastosowane też do wszystkich zaznaczonych obiektów',
	...
	'ROLE_ADMIN_STANDARD'		=> 'Normalny administrator',
	...
	'ROLE_USER_STANDARD'		=> 'Normalne możliwości',

	'ROLE_DESCRIPTION_ADMIN_FORUM'			=> 'Ma dostęp do zarządzania działami i uprawnieniami dostępu do nich.',
	'ROLE_DESCRIPTION_ADMIN_FULL'			=> 'Ma dostęp do wszystkich funkcji administracyjnych na tym forum.<br />Nie zalecane.',
	...
	'ROLE_DESCRIPTION_FORUM_FULL'			=> 'Ma możliwość korzystania ze wszystkich funkcji forum w danym dziale, w tym pisania ogłoszeń i przyklejania wątków. Może też ignorować limit wysłania jednej wiadomości w wybranym przez administratora czasie.<br />Nie zalecane dla normalnych użytkowników.',
	...
	'ROLE_DESCRIPTION_FORUM_NOACCESS'		=> 'Nie ma żadnego dostępu do forum.',
	...
	'ROLE_DESCRIPTION_FORUM_READONLY'		=> 'Ma możliwość czytania forum, ale nie może nic pisać, ani na nic odpowiadać.',
	'ROLE_DESCRIPTION_FORUM_STANDARD'		=> 'Ma możliwość korzystania z większości funkcji forum (w tym wysyłania załączników i usuwania własnych wątków), ale nie może zamykać własnych wątków ani tworzyć ankiet.',
	...
	'ROLE_DESCRIPTION_MOD_STANDARD'			=> 'Ma możliwość korzystania z większości funkcji moderacyjnych, ale nie może banować użytkowników ani zmieniać autora posta.',
	'ROLE_DESCRIPTION_USER_FULL'			=> 'Ma możliwość korzystania ze wszystkich dostępnych dla użytkowników funkcji forum, w tym zmiany nazwy użytkownika i ignorowania limitu wysłania jednej wiadomości w wybranym przez administratora okresie czasu.<br />Nie zalecane dla normalnych użytkowników.',
	...
	'ROLE_DESCRIPTION_EXPLAIN'		=> 'Masz możliwość wpisania krótkiego opisu co ten zestaw uprawnień robi lub w jakim celu został stworzony. Tekst, który tu wpiszesz, będzie wyświetlany też na stronach ustawiania uprawnień.',
	'ROLE_DESCRIPTION_LONG'			=> 'Opis zestawu jest za długi. Maksymalna dopuszczalna liczba znaków to 4 000.',
	...
	'SELECT_FORUM_SUBFORUM_EXPLAIN'	=> 'Wybranie z tej listy działu spowoduje wybranie również jego poddziałów.',
