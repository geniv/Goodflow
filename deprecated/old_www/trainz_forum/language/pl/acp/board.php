...
*
* @package language
* @version $Id: board.php,v 1.101.2 2007/01/18 LEW21 Exp $
...
$lang = array_merge($lang, array(
	...
	'BUMP_INTERVAL_EXPLAIN'			=> 'Liczba minut, godzin lub dni, między datą napisania ostatniego posta w wątku, a możliwością przesunięcia wątku w górę.',
...
$lang = array_merge($lang, array(
 ...
 'ACP_ANNOUCEMENTS' => 'Global annoucements',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_GZIP_EXPLAIN'		=> 'Wygenerowana zawartość zostanie skompresowana przed wysłaniem jej do użytkownika. W ten sposób można zmniejszyć transfer, ale i powiększyć użycie CPU na serwerze i u użytkownika.',
...
$lang = array_merge($lang, array(
	...
	'FORCE_PASS_CHANGE_EXPLAIN'		=> 'Wymagaj od użytkowników zmiany hasła po wybranej liczbie dni. Ustaw na 0, aby zablokować tą funkcję.',
	'FORM_TIME_MAX'					=> 'Maksymalny czas na wysłanie formularza',
	'FORM_TIME_MAX_EXPLAIN'			=> 'Czas, jaki ma użytkownik na wysłanie formularza. Ustaw na -1, aby zablokować tą funkcję. Pamiętaj, że formularz może stać się nieprawidłowy, jeśli sesja wygaśnie, niezależnie od tego ustawienia.',
	'FORM_TIME_MIN'					=> 'Minimalny czas na wysłanie formularza',
	'FORM_TIME_MIN_EXPLAIN'			=> 'Formularze wysłane szybciej zostaną zignorowane przez forum. Ustaw na 0, aby zablokować tą funkcję.',
