...
*
* @package language
* @version $Id: common.php,v 1.120.4 2007/01/18 LEW21 Exp $
...
$lang = array_merge($lang, array(
	...
	'ACP_BOARD_FEATURES'		=> 'Możliwości forum',
	...
	'ACP_STYLES'				=> 'Styl',
	// RSS
	'ACP_SYNDICATION'					=> 'Syndication settings',
	'ACP_SYNDICATION_FEEDS'	=> 'Syndication feeds',
	...
	'DOWNLOAD_STORE'			=> 'Ściągnij lub zapisz plik',
	'DOWNLOAD_STORE_EXPLAIN'	=> 'Możesz ściągnąć plik lub/i zapisać go w katalogu <samp>store/</samp>.',

	'EDIT'					=> 'Edytuj',
	'ENABLE'				=> 'Odblokuj',
	'EXPORT_DOWNLOAD'		=> 'Ściągnij',
	'EXPORT_STORE'			=> 'Zapisz',
...
$lang = array_merge($lang, array(
	'ADMIN_INTRO'				=> 'Dziękujemy za wybranie phpBB 3. Ta strona daje Ci możliwość szybkiego przejrzenia wszystkich statystyk forum. Odnośniki po lewej stronie umożliwiają kontrolę nad wszystkimi funkcjami forum. Na każdej stronie jest instrukcja jak używać zamieszczonych na niej narzędzi.',
	...
	'PURGE_CACHE_EXPLAIN'	=> 'Usuwa wszystkie zcache’owane elementy, w tym pliki szablonów i wyniki zapytań SQL.',
	...
	'RESYNC_POSTCOUNTS_EXPLAIN'		=> 'Tylko istniejące posty zostaną wzięte pod uwagę.',
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN'		=> 'Oto lista zarejestrowanych użytkowników, którzy nie dokonali jeszcze aktywacji konta. Możesz ich aktywować, usunąć lub przypomnieć im o aktywacji (wysyłając e-maila).',
...
$lang = array_merge($lang, array(
	...
	'LOG_ACL_ADD_FORUM_LOCAL_F_'		=> '<strong>Dodano lub przeedytowano lokalne uprawnienia dostępu do for</strong><br />%1$s<br /><strong>następującym użytkownikom/grupom</strong><br />» %2$s',
	...
	'LOG_ACL_DEL_FORUM_LOCAL_F_'		=> '<strong>Usunięto lokalne uprawnienia dostępu do for</strong><br />%1$s<br /><strong>następującym użytkownikom/grupom</strong><br />» %2$s',
	...
	// RSS
	'LOG_CONFIG_SYNDICATION'	=> '<strong>Changed syndication feeds configuration</strong>',
	...
	'LOG_DELETE_TOPIC'			=> '<strong>Usunięto wątek</strong><br />» %s',
	...
	'LOG_MOVE'					=> '<strong>Przeniesiono wątek</strong><br />» z %s',
	...
	'LOG_TOPIC_DELETED'			=> '<strong>Usunięto wątek</strong><br />» %s',
	...
	'LOG_GROUP_CREATED'		=> '<strong>Stworzono nową grupę</strong><br />» %s',
	...
	'LOG_MCP_CHANGE_POSTER'	=> '<strong>Zmieniono autora posta w wątku „%1$s”</strong><br />» z %2$s na %3$s',
	...
	'LOG_F_ROLE_ADD'		=> '<strong>Dodano zestaw uprawnień dostępu do for</strong><br />» %s',
	'LOG_F_ROLE_EDIT'		=> '<strong>Przeedytowano zestaw uprawnień dostępu do for</strong><br />» %s',
	'LOG_F_ROLE_REMOVED'	=> '<strong>Usunięto zestaw uprawnień dostępu do for</strong><br />» %s',
	...
	'LOG_TEMPLATE_CACHE_CLEARED'	=> '<strong>Wyczyszczono pamięć podręczną plików z zestawu szablonów <em>%1$s</em></strong><br />» %2$s',
	...
	'LOG_THEME_ADD_DB'			=> '<strong>Zainstalowano nowy temat</strong><br />» %s',
	'LOG_THEME_ADD_FS'			=> '<strong>Zainstalowano nowy temat</strong><br />» %s',
	'LOG_THEME_DELETE'			=> '<strong>Usunięto temat</strong><br />» %s',
	'LOG_THEME_EDIT_DETAILS'	=> '<strong>Przeedytowano szczegóły tematu</strong><br />» %s',
	'LOG_THEME_EDIT'			=> '<strong>Przeedytowano temat <em>%1$s</em></strong>',
	'LOG_THEME_EDIT_FILE'		=> '<strong>Przeedytowano temat <em>%1$s</em></strong><br />» Przeedytowano plik <em>%2$s</em>',
	'LOG_THEME_EXPORT'			=> '<strong>Wyeksportowano temat</strong><br />» %s',
	'LOG_THEME_REFRESHED'		=> '<strong>Odświeżono temat</strong><br />» %s',
