...
*
* @package language
* @version $Id: forums.php,v 1.32.1 2007/12/23 Ronnie Exp $
...
$lang = array_merge($lang, array(
	'AUTO_PRUNE_DAYS'			=> 'Czas od napisania ostatniego posta',
	'AUTO_PRUNE_DAYS_EXPLAIN'	=> 'Liczba dni od napisania ostatniego posta w wątku, po jakiej wątek jest usuwany.',
	...
	'FORUM_ADMIN_EXPLAIN'				=> 'W phpBB3 nie ma kategorii w rozumieniu z phpBB2, wszystko jest oparte na działach. Każdy dział może mieć dowolną liczbę poddziałów i możesz wybrać czy ma być możliwość pisania w nim, czy nie (tzn. czy ma zachowywać się jak kategoria z phpBB2). Tutaj możesz dodawać, edytować, usuwać, blokować i odblokowywać pojedyncze działy i zmieniać ich ustawienia. Jeśli wątki i posty w nich uległy desynchronizacji, możesz też ponownie zsynchronizować dział. <strong>Aby nowoutworzone działy były wyświetlane musisz skopiować albo ustawić uprawnienia dostępu do nich.</strong>',
	...
	'LINK'					=> 'Link',
	'LIST_INDEX'			=> 'Wymień poddział w opisie działu - rodzica',
	'LIST_INDEX_EXPLAIN'	=> 'Wyświetla nazwę tego działu jako link na stronie głównej i w innych miejscach w opisie jego działu - rodzica.',
	'LOCKED'				=> 'Zablokowany',
	...
	'PARENT_IS_LINK_FORUM'		=> 'Wybrany rodzic jest działem - linkiem. Działy - linki nie moga zawierać innych działów, wybierz inny dział.',
	'PARENT_NOT_EXIST'			=> 'Rodzic nie istnieje.',
