...
/**
*
* acp_permissions (Zestaw uprawnień phpBB) [Polski]
*
* @package language
* @version $Id: permissions_phpbb.php,v 1.29.2 2007/01/18 LEW21 Exp $
...
// User Permissions
$lang = array_merge($lang, array(
	'acl_u_viewprofile'	=> array('lang' => 'Może oglądać profile, listę użytkowników i listę przeglądających forum', 'cat' => 'profile'),
	...
	'acl_u_download'	=> array('lang' => 'Może ściągać pliki', 'cat' => 'post'),
	...
	'acl_u_masspm'		=> array('lang' => 'Może wysyłać PW do wielu użytkowników i grup na raz', 'cat' => 'pm'),
	...
	'acl_u_pm_download'	=> array('lang' => 'Może ściągać pliki załączone w prywatnych wiadomościach', 'cat' => 'pm'),
...
$lang = array_merge($lang, array(
	...
	'acl_f_download'	=> array('lang' => 'Może ściągać załączone pliki', 'cat' => 'content'),
	...
	'acl_f_syndication'	=> array('lang' => 'Może dodawać RSS/Atom', 'cat' => 'content'),

	'acl_f_edit'		=> array('lang' => 'Może edytować swoje posty', 'cat' => 'actions'),
	'acl_f_delete'		=> array('lang' => 'Może usuwać swoje posty', 'cat' => 'actions'),
	'acl_f_user_lock'	=> array('lang' => 'Może zamykać swoje wątki', 'cat' => 'actions'),
...
$lang = array_merge($lang, array(
	...
	'acl_m_chgposter'	=> array('lang' => 'Może zmieniać autora posta', 'cat' => 'post_actions'),

	'acl_m_move'	=> array('lang' => 'Może przenosić wątki', 'cat' => 'topic_actions'),
	'acl_m_lock'	=> array('lang' => 'Może zamykać wątki', 'cat' => 'topic_actions'),
	'acl_m_split'	=> array('lang' => 'Może dzielić wątki', 'cat' => 'topic_actions'),
	'acl_m_merge'	=> array('lang' => 'Może łączyć wątki', 'cat' => 'topic_actions'),

	'acl_m_info'	=> array('lang' => 'Może oglądać szczegóły posta', 'cat' => 'misc'),
