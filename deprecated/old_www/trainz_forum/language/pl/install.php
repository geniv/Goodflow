...
*
* @package language
* @version $Id: install.php,v 1.131.2 2007/01/18 LEW21 Exp $
...
$lang = array_merge($lang, array(
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Udało Ci się przekonwertować Twoje forum na phpBB 3.0. Możesz się teraz zalogować i <a href="../">wejść na swoje forum</a>. Zanim odblokujesz swoje forum, (usuwając katalog install/) upewnij się, że ustawienia zostały skopiowane prawidłowo. Pamiętaj, że pomoc w używaniu phpBB możesz uzyskać czytając <a href="http://phpbb3.pl/support/documentation/" rel="external">dokumentację</a> i pytając na forum <a href="http://phpbb3.pl/" rel="external">phpBB3.PL</a>.',
	'CONVERT_INTRO'				=> 'Witamy w Ujednoliconym Systemie Konwerującym phpBB', // Unified Convertor Framework
	'CONVERT_INTRO_BODY'		=> 'Możesz stąd zaimportować dane z innych (zainstalowanych) skryptów do tworzenia for dyskusyjnych do phpBB3. Lista poniżej zawiera wszystkie dostępne moduły konwertujące. Jeśli na liście nie ma konwertera, którego potrzebujesz, to sprawdź na naszej stronie - może pojawił się on już na niej.',
	...
	'FILES_OPTIONAL_EXPLAIN'	=> '<strong>Opcjonalne</strong> - Te pliki, foldery lub zezwolenia, nie są wymagane. Instalator spróbuje wielu metod, aby je utworzyć, jeśli one nie istnieją lub nie są zapisywalne, jednak ich obecność przyspieszy instalację.',
	'FILES_REQUIRED'			=> 'Pliki i foldery',
	'FILES_REQUIRED_EXPLAIN'	=> '<strong>Wymagane</strong> - phpBB potrzebuje możliwości odczytywania lub zapisywania tych plików. Napis „Nie znaleziono” oznacza, że musisz utworzyć odpowiedni plik lub folder, a napis „Niezapisywalne” oznacza, że musisz zmienić zezwolenia dostępu do odpowiedniego pliku lub folderu, aby umożliwić phpBB zapisywanie w nim informacji.',
	...
	<ul>
		<li>MySQL, w wersji wyższej lub równej 3.23 (MySQLi supported)</li>
	...
	'INST_ERR_DB_NO_POSTGRES'		=> 'Wybrana baza danych nie została stworzona w kodowaniu <var>UNICODE</var> lub <var>UTF8</var>. Spróbuj zainstalować forum z bazą danych o kodowaniu <var>UNICODE</var> lub <var>UTF8</var>.',
	...
	'OVERVIEW_BODY'				=> 'Witamy w phpBB3!<br /><br />phpBB™ jest najczęściej na świecie używanym rozwiązaniem forów internetowych o otwartym kodzie. phpBB3 to efekt siedmioletniej pracy phpBB Group. Tak jak jego poprzednicy, phpBB3 ma wiekie możliwości, jest przyjazny dla użytkowników i w pełni wspierany przez phpBB Group. phpBB3 posiada te walory, które spowodowały ogromną popularność phpBB2, oraz dodaje najczęściej zgłaszane funkcje, których w poprzednich wersjach brakowało. Mamy nadzieję, że spełnia Twoje oczekiwania.<br /><br />Ten instalator przeprowadzi Cię przez proces instalacji phpBB3, aktualizowania skryptu do najnowszej wersji oraz konwersji do phpBB3 z innych skryptów forów dyskusyjnych (m.in. phpBB2). Więcej informacji można znaleźć w <a href="../docs/INSTALL.html">przewodniku instalacji</a>.<br /><br />Żeby przeczytać licencję phpBB3 lub dowiedzieć się więcej o uzyskiwaniu pomocy, wybierz odpowiednią opcję z bocznego menu. Aby kontynuować, wybierz odpowiednią kartę powyżej.',
	...
	'SEARCH_INDEX_UNCONVERTED_EXPLAIN'=> 'Indeks wyszukiwarki ze starego forum nie został przekonwertowany. Wyszukiwanie zawsze będzie zwracać pusty rezultat. Aby stworzyć nowy indeks wyszukiwarki idź do Panelu Administracyjnego, wybierz <span style="text-transform: uppercase;">Zarządzanie</span>, a następnie kliknij na Indeks wyszukiwarki.',
	...
	'STAGE_CREATE_TABLE_EXPLAIN'=> 'Tabele używane przez phpBB 3.0 zostały utworzone i wypełnione podstawowymi informacjami. Przejdź dalej, żeby zakończyć instalację phpBB.',
	...
	'UPDATE_TOPICS_POSTED_ERR'	=> 'Wystąpił błąd w czasie generowania informacji o napisanych wątkach. Gdy skończysz konwersję, będziesz mógł zsynchronizować te informacje w Panelu Administracyjnym.',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Wszystkie pliki są identyczne z plikami najnowszej wersji phpBB3. Teraz powinieneś <a href="../ucp.php?mode=login">się zalogować</a> i sprawdzić czy wszystko działa właściwie. Nie zapomnij usunąć, zmienić nazwę lub przesunąć katalog install/!',
	...
	'CURRENT_FILE'					=> 'Początek aktualnego, orginalnego pliku',
	...
	'DIFF_SEP_EXPLAIN'					=> 'Koniec aktualnego, orginalnego pliku / Początek nowej wersji pliku',
	'DIFF_SIDE_BY_SIDE'					=> 'Wersja obok wersji',
	'DIFF_UNIFIED'						=> 'Ujednolicony diff',
	'DO_NOT_UPDATE'						=> 'Nie aktualizuj tego pliku',
	'DONE'								=> 'Zrobione',
	'DOWNLOAD'							=> 'Ściągnij',
	'DOWNLOAD_AS'						=> 'Ściągnij jako',
	'DOWNLOAD_UPDATE_METHOD'			=> 'Ściągnij archiwum z zmodyfikowanymi plikami',
	'DOWNLOAD_UPDATE_METHOD_EXPLAIN'	=> 'Po ściągnięciu powinieneś rozpakować archiwum. Znajdziesz w nim zmodyfikowane pliki, które musisz wgrać do głównego katalogu Twojej instalacji phpBB3. Gdy to zrobisz, sprawdź pliki ponownie za pomocą innego z poniższych przycisków.',
	...
	'FILES_NOT_MODIFIED_EXPLAIN'	=> 'Te pliki nie zostały zmodyfikowan i są identyczne z plikami wersji phpBB, z której aktualizujesz.',
	...
	'MERGE_MOD_FILE_OPTION'		=> 'Połącz zmiany i użyj zmodyfikowanego kodu w blokach, w których zachodzi konflikt',
	'MERGE_NEW_FILE_OPTION'		=> 'Połącz zmiany i użyj kodu nowej wersji pliku w blokach, w których zachodzi konflikt',
	...
	'NEW_FILE'						=> 'Koniec nowej wersji pliku',
	...
	'NUMBER_OF_FILES_COLLECTED'		=> 'Aktualnie zebrano różnice w %1$d plikach (z %2$d łącznie).<br />Poczekaj aż zbieranie zostanie zakończone.',
	...
	'SELECT_DOWNLOAD_FORMAT'	=> 'Wybierz format archiwum do ściągnięcia',
...
<p>Ten tryb pozwala Ci ściągnąć Twoje zmodyfikowane pliki, wykonać potrzebne poprawki i samodzielnie wgrać je na serwer. Po wgraniu plików powinieneś wykonać ponowny test. Jeśli wszystko będzie zaktualizowane, zostaniesz przeniesiony do aktualizacji bazy danych.</p>
...
<p>Ta metoda jest podobna do pierwszej, ale zamiast samodzielnie wgrywać pliki wystarczy, że podasz informacje dotyczące logowania do Twojego serwera FTP. Po zakończeniu wgrywania pliki zostaną porównane ponownie. Jeśli wszystko będzie zaktualizowane, zostaniesz przeniesiony do aktualizacji bazy danych.',
	'UPDATE_INSTRUCTIONS'			=> '<h1>Ogłoszenie o wydaniu</h1>
		...
		<p>Przeczytaj <a href="%1$s" title="%1$s"><strong>ogłoszenie o wydaniu najnowszej wersji</strong></a> zanim przejdziesz dalej, ponieważ może ono zawierać przydatne wiadomości. Na pewno zawiera ono linki do ściągnięcia skryptu oraz historię zmian.</p>
		...
		<ul style="margin-left: 20px; font-size: 1.1em;">
			<li>Przejdź na stronę <a href="http://www.phpbb.com/downloads/">http://www.phpbb.com/downloads/</a> i ściągnij archiwum „Automatic Update Package”.<br /><br /></li>
	...
	'UPDATE_METHOD_EXPLAIN'			=> 'Teraz możesz wybrać preferowaną metodę aktualizacji. Wybranie „Wgrania za pomocą FTP” spowoduje wyświetlenie formularza, do którego będziesz musiał wpisać informacje o Twoim koncie FTP. Ta metoda spowoduje, że pliki zostaną automatycznie zaktualizowane, a do nazw starych wersji plików zostanie dodane rozszerzenie .bak. Jeśli wybierzesz „Ściągnięcie zmodyfikowanych plików”, będziesz musiał wgrać je na serwer samodzielnie.',
...
$lang = array_merge($lang, array(
	...
	'EXT_GROUP_DOWNLOADABLE_FILES'	=> 'Ściągalne pliki',
	...
	'REPORT_OFF_TOPIC'				=> 'Treść posta nie dotyczy wątku dyskusji.',
