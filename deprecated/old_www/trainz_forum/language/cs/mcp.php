...
$lang = array_merge($lang, array(
	...
	'ADD_FEEDBACK_EXPLAIN'	=> 'Jestliže chcete přidat poznámku k uživateli, prosím vyplňte tento formulář. Používejte pouze prostý text; HTML, BBCode atd. nejsou povoleny.',
	...
	'TOPICS_TYPE_CHANGED'		=> 'Druh témat byl úspěšně změněn.',
	...
	'report_reasons'		=> array(
		...
		'DESCRIPTION' => array(
			...
			'BORRO'		=> 'Uživatel se snaží tvářit jako odborník na všechno. Poskytuje informace, které se nezakládají na pravdě a nesnese konstruktivní kritiku.',
			'FLAMEWAR'		=> 'Uraží a napadá jiné uživatele. Vyvolává zbytečně vášnivé diskuse.',
			'GRAMATIKA'		=> 'Neumí psát gramaticky správně Česky a přitom jde o jeho rodilou řeč.',
			'PLUSONE'		=> 'Píše příspěvky bez obsahu a valného významu (tzv. +1) a zbytečně tím natahuje vlákno.',
	)
	),
));
