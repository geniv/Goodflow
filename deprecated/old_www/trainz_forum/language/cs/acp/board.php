...
$lang = array_merge($lang, array(
	...
	'WARNINGS_BAN'			           		=> 'Počet varování než-li uživatel dostane ban',
	'WARNINGS_BAN_EXPLAIN'			     => 'Počet varování před tím než-li uživatel dostane automaticky ban.',
	'WARNINGS_BAN_EXPIRE'		      	=> 'Čas vypršení automatického ban',
	'WARNINGS_BAN_EXPIRE_EXPLAIN'	=> 'Čas v minutách, po kterém se automatický ban zruší.',
...
//	'ACC_USER_ADMIN'			=> 'Uživatelem a Administrátorem',
	...
	'MAX_CHARS'					=> 'Max',
	'MIN_CHARS'					=> 'Min',
	'MIN_TIME_REG'				=> 'Minimální doba pro zaregistrování',
	'MIN_TIME_REG_EXPLAIN'		=> 'Registrační formulář nemůže být odeslán před uplynutím nastaveného limitu.',
	'MIN_TIME_TERMS'			=> 'Minimální doba zobrazení podmínek registrace',
	'MIN_TIME_TERMS_EXPLAIN'	=> 'Nelze přeskočit stránku s podmínkami registrace před uplynutím nastaveného limitu.',
	...
	// ACCOUNT VERIFICATION BY FOREIGN DATABASE // (c) JediSoft.cz, 2008
  'ACC_DATABASE'					=> 'Jinou databází',
  'DUV_LEGEND'            => 'Nový účet ověřit proti jiné databázi',
  'DUV_SERVER'            => 'Server',
  'DUV_SERVER_EXPLAIN'    => 'Databázový server, na kterém jsou uloženy údaje o uživateli.',
  'DUV_DBUSER'            => 'Uživatelský účet',
  'DUV_DBUSER_EXPLAIN'    => 'Uživatelský účet, kterým se má provést připojení k databázi.',
  'DUV_DBPASSWD'          => 'Heslo',
  'DUV_DBPASSWD_EXPLAIN'  => 'Heslo k databázi. POZOR! Heslo bude uloženo v čitelné podobě.',
  'DUV_DATABASE'          => 'Databáze',
  'DUV_DATABASE_EXPLAIN'  => 'Databáze, ve které je uložena tabulka s uživatelskými účty',
  'DUV_DBTABLE'           => 'Tabulka uživatelů',
  'DUV_DBTABLE_EXPLAIN'   => 'Databázová tabulka se seznamem uživatelů',
  'DUV_TA_USER'           => 'Sloupec uživatelských jmen',
  'DUV_TA_USER_EXPLAIN'   => 'Název sloupce uživatelských jmen uvedených v databázi.',
  'DUV_TA_PASSWD'         => 'Sloupec hesel',
  'DUV_TA_PASSWD_EXPLAIN' => 'Název sloupce hesel k uživatelským účtům uvedených v databázi.',
  'DUV_TAU_VERIFY'        => 'Způsob ověření uživatelského jména',
  'DUV_TAU_VERIFY_EXPLAIN' => 'Zvolte způsob, jakým se má provést porovnání uživatelského jména',
  'DUV_TAP_VERIFY'        => 'Způsob ověření hesla',
  'DUV_TAP_VERIFY_EXPLAIN' => 'Zvolte způsob, jakým se má provést ověření a porovnání hesla',
  'DUV_COPY'              => 'Okopírovat další sloupce',
  'DUV_COPY_EXPLAIN'      => 'Pro exprerty: Zapište název sloupce z místí tabulky a přiřaďte mu název sloupce z ověřovací tabulky. Příklad: user_email=nuke_email, user_icq=nuke_icq, atd.',

  'DUV_SQL'               => 'Extra podmínky v SQL dotazu',
  'DUV_SQL_EXPLAIN'       => 'Nepovinný údaj. Dodržujte syntax SQL. Retězec by měl odpovídat tomu, co následuje za klausulí WHERE',

  'DUV_ENCODING'          => 'Kódování textu',
  'DUV_ENCODING_EXPLAIN'  => 'Kódování textu ve zdrojové tabulce dat.',
  'DUV_SEL_LIKE'          => 'LIKE',
  'DUV_SEL_EQUALS'        => '=',
  'DUV_SEL_PLAIN'         => 'Hesla nejsou šifrována',
  'DUV_SEL_MD5'           => 'Šifrováno: MD5',
  'DUV_SEL_OLDPASSWORD'   => 'Šifrováno: OLD_PASSWORD',
  'DUV_SEL_PASSWORD'      => 'Šifrováno: PASSWORD',
...
$lang = array_merge($lang, array(
 ...
 'ACP_ANNOUCEMENTS' => 'Globální oznámení',
 'LOAD_GLOBAL_ANNOUNCEMENTS_HOME'		=> 'Zobrazit globální oznámení na hlavní stránce',
	'LOAD_GLOBAL_ANNOUNCEMENTS_TOPIC'		=> 'Zobrazit globální oznámení na stránkách témat',
...
$lang = array_merge($lang, array(
	...
	'FORM_TIME_MIN'               => 'Minimální limit k odeslání formuláře',
	'FORM_TIME_MIN_EXPLAIN'         => 'Odeslání v kratším než zde nastaveném čase bude fórum ignorovat. Hodnota 0 funkci zruší.',
