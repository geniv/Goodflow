...
class ucp_prefs
{
    ...
    $user->add_lang('mods/info_acp_syndication');
				...
				$data = array(
					...
					// RSS
					'syndication_method'	=> request_var('syndication_method', $user->data['user_syndication_method']),
				...
				if ($submit)
				{
					...
					if (!sizeof($error))
					{
						...
						$sql_ary = array(
							...
							// RSS
							'user_syndication_method'	=> $data['syndication_method'],
						);
				...
				$template->assign_vars(array(
					...
					'S_DST'				=> $data['dst'],
					// RSS
					'S_SYNDICATION_METHOD'	=> $data['syndication_method'],
