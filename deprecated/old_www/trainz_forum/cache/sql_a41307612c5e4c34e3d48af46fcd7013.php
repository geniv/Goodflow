...
/* SELECT s.style_id, c.theme_data, c.theme_path, c.theme_name, c.theme_mtime, i.*, t.template_path FROM pb_styles s, pb_styles_template t, pb_styles_theme c, pb_styles_imageset i WHERE s.style_id = 3 AND t.template_id = s.template_id AND c.theme_id = s.theme_id AND i.imageset_id = s.imageset_id */

$expired = (time() > 1206967920) ? true : false;
if ($expired) { return; }
...
.navbar {
	background-color: #000; /* puvodni barva #ebebeb */
	padding: 0 10px;
}
...
',
    ...
    'theme_mtime' => '1206876662',
    'imageset_id' => '3',
    'imageset_name' => 'trainzclassics',
    'imageset_copyright' => '&copy; Trainz CSU, 2008',
