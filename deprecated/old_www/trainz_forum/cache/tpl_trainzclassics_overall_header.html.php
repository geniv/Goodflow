...
<?php } if ($this->_rootref['S_SYNDICATION_ENABLED']) {  ?>
	<link rel="alternate" type="<?php echo (isset($this->_rootref['FEED_TYPE'])) ? $this->_rootref['FEED_TYPE'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_SYNDICATION1'])) ? $this->_rootref['L_SYNDICATION1'] : ((isset($user->lang['SYNDICATION1'])) ? $user->lang['SYNDICATION1'] : '{ SYNDICATION1 }')); ?>" href="<?php echo (isset($this->_rootref['U_FEED1'])) ? $this->_rootref['U_FEED1'] : ''; ?>" />
	<?php if ($this->_rootref['U_FEED2']) {  ?>
		<link rel="alternate" type="<?php echo (isset($this->_rootref['FEED_TYPE'])) ? $this->_rootref['FEED_TYPE'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_SYNDICATION2'])) ? $this->_rootref['L_SYNDICATION2'] : ((isset($user->lang['SYNDICATION2'])) ? $user->lang['SYNDICATION2'] : '{ SYNDICATION2 }')); ?>" href="<?php echo (isset($this->_rootref['U_FEED2'])) ? $this->_rootref['U_FEED2'] : ''; ?>" />
	<?php } if ($this->_rootref['U_FEED3']) {  ?>
		<link rel="alternate" type="<?php echo (isset($this->_rootref['FEED_TYPE'])) ? $this->_rootref['FEED_TYPE'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_SYNDICATION3'])) ? $this->_rootref['L_SYNDICATION3'] : ((isset($user->lang['SYNDICATION3'])) ? $user->lang['SYNDICATION3'] : '{ SYNDICATION3 }')); ?>" href="<?php echo (isset($this->_rootref['U_FEED3'])) ? $this->_rootref['U_FEED3'] : ''; ?>" />
		<link rel="alternate" type="<?php echo (isset($this->_rootref['FEED_TYPE'])) ? $this->_rootref['FEED_TYPE'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_SYNDICATION4'])) ? $this->_rootref['L_SYNDICATION4'] : ((isset($user->lang['SYNDICATION4'])) ? $user->lang['SYNDICATION4'] : '{ SYNDICATION4 }')); ?>" href="<?php echo (isset($this->_rootref['U_FEED4'])) ? $this->_rootref['U_FEED4'] : ''; ?>" />
	<?php } } ?>
	...
	<div id="page-header">
		...
		<div class="navbar">
			...
			<ul class="linklist navlinks">
				...
				<?php if ($this->_rootref['S_SYNDICATION_ENABLED']) {  ?><li class="rightside"><a href="<?php echo (isset($this->_rootref['U_SYNDICATION'])) ? $this->_rootref['U_SYNDICATION'] : ''; ?>"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/syndication.png" alt="<?php echo ((isset($this->_rootref['L_SYNDICATION'])) ? $this->_rootref['L_SYNDICATION'] : ((isset($user->lang['SYNDICATION'])) ? $user->lang['SYNDICATION'] : '{ SYNDICATION }')); ?>" /></a></li><?php } ?>
