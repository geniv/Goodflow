...
<div class="panel">
 ...
 <dl>
		<dt><label for="syndication1"><?php echo ((isset($this->_rootref['L_SYNDICATION_METHOD'])) ? $this->_rootref['L_SYNDICATION_METHOD'] : ((isset($user->lang['SYNDICATION_METHOD'])) ? $user->lang['SYNDICATION_METHOD'] : '{ SYNDICATION_METHOD }')); ?>:</label></dt>
		<dd>
			<label for="syndication0"><input type="radio" name="syndication_method" id="syndication0" value="0"<?php if ($this->_rootref['S_SYNDICATION_METHOD'] == 0) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_SYNDICATION_ATOM'])) ? $this->_rootref['L_SYNDICATION_ATOM'] : ((isset($user->lang['SYNDICATION_ATOM'])) ? $user->lang['SYNDICATION_ATOM'] : '{ SYNDICATION_ATOM }')); ?></label>
			<label for="syndication1"><input type="radio" name="syndication_method" id="syndication2" value="1"<?php if ($this->_rootref['S_SYNDICATION_METHOD'] == 1) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_SYNDICATION_RSS2'])) ? $this->_rootref['L_SYNDICATION_RSS2'] : ((isset($user->lang['SYNDICATION_RSS2'])) ? $user->lang['SYNDICATION_RSS2'] : '{ SYNDICATION_RSS2 }')); ?></label>
		</dd>
	</dl>
	<dl>
