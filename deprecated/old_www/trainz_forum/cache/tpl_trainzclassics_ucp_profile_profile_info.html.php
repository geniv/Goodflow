...
<div class="panel">
	...
	<dl>
		<dt><label for="gender_x"><?php echo ((isset($this->_rootref['L_GENDER'])) ? $this->_rootref['L_GENDER'] : ((isset($user->lang['GENDER'])) ? $user->lang['GENDER'] : '{ GENDER }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_GENDER_EXPLAIN'])) ? $this->_rootref['L_GENDER_EXPLAIN'] : ((isset($user->lang['GENDER_EXPLAIN'])) ? $user->lang['GENDER_EXPLAIN'] : '{ GENDER_EXPLAIN }')); ?></span></dt>
		<dd>
			<input type="radio" name="gender" id="gender_m" value="<?php echo (isset($this->_rootref['GENDER_M'])) ? $this->_rootref['GENDER_M'] : ''; ?>"<?php if ($this->_rootref['S_GENDER_M']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_GENDER_M'])) ? $this->_rootref['L_GENDER_M'] : ((isset($user->lang['GENDER_M'])) ? $user->lang['GENDER_M'] : '{ GENDER_M }')); ?>
			<input type="radio" name="gender" id="gender_f" value="<?php echo (isset($this->_rootref['GENDER_F'])) ? $this->_rootref['GENDER_F'] : ''; ?>"<?php if ($this->_rootref['S_GENDER_F']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_GENDER_F'])) ? $this->_rootref['L_GENDER_F'] : ((isset($user->lang['GENDER_F'])) ? $user->lang['GENDER_F'] : '{ GENDER_F }')); ?>
			<input type="radio" name="gender" id="gender_x" value="<?php echo (isset($this->_rootref['GENDER_X'])) ? $this->_rootref['GENDER_X'] : ''; ?>"<?php if ($this->_rootref['S_GENDER_X']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_GENDER_X'])) ? $this->_rootref['L_GENDER_X'] : ((isset($user->lang['GENDER_X'])) ? $user->lang['GENDER_X'] : '{ GENDER_X }')); ?>
		</dd>
	</dl>
