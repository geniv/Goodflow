...
switch ($mode)
{
	case 'leaders':
		...
		$sql = $db->sql_build_query('SELECT', array(
			'SELECT'	=> 'u.user_id, u.group_id as default_group, u.username, u.username_clean, u.user_colour, u.user_rank, u.user_posts, u.user_allow_pm, u.user_gender, g.group_id, g.group_name, g.group_colour, g.group_type, ug.user_id as ug_user_id',
...
function show_profile($data)
{
  ...
  //-- mod : Genders ------------------------------------------------------------
		'USER_GENDER_IMG'	=> get_user_gender($data['user_gender'], false),
