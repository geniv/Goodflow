...
/**
 *
 * Blok dynamicky generovane nastavby dynamickeho obsahu
 *
 * public funkce:\n
...
{
  private $var, $sqlite, $dbname, $dirpath, $adresy, $unikatni;
 ...
 */
  public function __construct(&$var, $index) //konstruktor
  {
    ...
    //rozsiri adresu menu o sekce z tohoto modulu
 ...
 */
  private function ZpracovaniAdres($adr = NULL)
  {
    ...
    $klice = (!Empty($this->adresy) ? array_keys($this->adresy) : "");

    $result = "";
    if (!Empty($this->adresy))
    {
    ...
    {
      $result = "nejsou dostupné žádné adresy z dynamickych obsahu<br />";
    }
