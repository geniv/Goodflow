 ...
 * SeznamAdres() - vtrati seznam adres v poli\n
 ...
 *
 * pouziti: <strong>$text = $this->var->main[0]->NactiFunkci("DynamicObsah", "SeznamAdres");</strong>
 *
 * @return indexovane pole adres
 */
  public function SeznamAdres()
  {
    $result = "";
 ...
 */
  private function AdministraceObsahu()
  {
    ...
    ".($this->povolit_pridani ? "<a href=\"?{$this->var->get_kam}={$this->var->adresaadminu}&amp;{$this->var->get_idmodul}={$this->idmodul}&amp;co=add\" title=\"\">přidej obsah</a><br />" : "")."
    ...
    if (!Empty($co))
    {
      switch ($co)
      {
        case "add": //pridavani
          ...
          <form method=\"post\">
            <fieldset>
              adresa: <input type=\"text\" name=\"adresa\" value=\"{$_GET["adresa"]}\" /> <br />
...
".($this->povolit_pridani ? "<a href=\"?{$this->var->get_kam}={$this->var->adresaadminu}&amp;{$this->var->get_idmodul}={$this->idmodul}&amp;co=del&amp;id={$data->id}\" title=\"\" onclick=\"return confirm('Opravdu smazat adresu: \'{$data->adresa}\' ?');\">smazat sekci</a>" : "")."
</p>
          ";
        }
      }
