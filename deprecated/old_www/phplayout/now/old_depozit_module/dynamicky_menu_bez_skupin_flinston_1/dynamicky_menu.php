...
class DynamicMenuWithoutGroup1 extends DefaultModule
{
  private $var;
  private $sqlite;
  private $dbname;
  private $idmodul = "dynmenuoutgrup1";  //id pro rozliseni modulu v adminu
  private $dirpath;
  ...
  private $go_default = true;  //true/false - povoleni auto navratu na default
 ...
 */
  public function __construct(&$var, $index) //konstruktor
  {
    ...
    $adresa_menu = array( array("main_href" => "{$this->idmodul}",
                                "odkaz" => "Statické menu - záhlaví 1",
                                "title" => "Statické menu - záhlaví 1",
                                "id" => "",
                                "class" => "staticke_menu_1_menu",
                                "akce" => ""),
                          );
        ...
        case "add": //pridavani poloze menu
          ...
          <form method=\"post\">
            <fieldset>
              ...
              poradi: <input type=\"text\" name=\"poradi\" value=\"{$this->PocetRadku(1)}\" /><br />
            ...
            if ($res->numRows() == 1)
            {
              ...
              <form method=\"post\">
                <fieldset>
                  ...
                  href: <input type=\"text\" name=\"href\" value=\"{$data->href}\" /><br />
