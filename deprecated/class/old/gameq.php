 ...
 */
  ...
  use classes\GameQ\Buffer,
      classes\GameQ\Config,
      classes\GameQ\Communicate,
      classes\GameQ\ParsingException,
      classes\GameQ\Result;
 ...
 */
class GameQ {
    const VERSION = 1.18; //gmr upgrade version

    //const GAMEQ_BASE = 'qameq/';
    ...
    public function setFilter($name, $params = array()) {
        // Load it
        $class = 'classes\GameQ\Filter\Filter_' . $name;
    ...
    private function getProtocol($name) {
        ...
        // Load it
        $class = 'classes\GameQ\Protocol\\'.$name;
    ...
    private function processChallengeResponse($prot, $data, $response) {
        ...
        $prot->setData(new Buffer($response));
    ...
    private function processResponse($protname, $packetname, $data) {
        ...
        // Parse the packet
        $prot->setData(new Buffer($data), new Result());
