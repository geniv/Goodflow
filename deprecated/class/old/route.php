 ...
 */
  ...
  final class Route {
     ...
     * @param from_index vzit od indexu pole
     * @param length_index vzit delku indexu pole
     * @return vysledne asociativni pole slozene z modelu a request adresy
     */
    public function getUri(array $routemodel = null, $from_index = 0, $length_index = null) {
      $result = null;
      ...
      // pokud je pozadovano parsovat od indexu, po urcitou delku pole
      if ($from_index > 0 || $length_index > 0) {
        $result = array_slice($result, $from_index, $length_index);
      }
      return $result;
    }
  }
