...
/*
    ...
    $theme_panel = SelectionTheme::getInstance()->controlPanel();
*/
...
//var_dump(Core::getUrl(), Core::getAbsoluteUrl());

    $title = ModuleDirs::getPageTitle(array('before' => $title_galery));


//TODO pres getPageMenu a getPageContent predavat Html::XXX kostru pro vypis
    $sablona_menu = Html::elem('a') //TODO doresit!
                        ->href('{href_link}')
                        ->class('{podminka}')
                        ->setText('{name}');


    $menu = Html::elem('div')->id('menu')->setText(ModuleDirs::getPageMenu($sablona_menu));
    ...
    $end_time = Html::elem('span')->setText(array(Core::stopTime(), NULL)); //, $theme_panel
