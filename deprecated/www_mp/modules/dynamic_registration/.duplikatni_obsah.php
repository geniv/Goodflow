<?php
  ...
  $result = array("admin_menu" => array(array("main_href" => "%%1%%",
                  ...
                  "normal_def_form" => array ("jmeno" => array("name" => "Jméno", "typ" => "text", "value" => "", "moznosti" => array(), "show" => array("registr", "profil"), "povinne" => true, "fpovinne" => "", "class" => ""),
                                              ...
                                              "vek" => array("name" => "Věk", "typ" => "select", "value" => "15 let", "moznosti" => array("15 let", "16 let", "17 let", "18 let", "19 let", "20 let", "21 let", "22 let", "23 let", "24 let", "25 let", "26 let", "27 let", "28 let", "29 let", "30 let"), "show" => array("registr", "profil"), "povinne" => true, "fpovinne" => "", "class" => ""),
                                              ...
                                              "novinky" => array("name" => "Přihlásit se k odběru newsletteru:", "typ" => "checkbox", "value" => true, "moznosti" => array(), "show" => array("registr", "profil"), "povinne" => false, "fpovinne" => "", "class" => " class=\"check\""),
...
<label%%1%%>
  ...
  %%5%%
                  ...
                  "normal_registrace_done" => "Registrace proběhla v pořádku. Nyní vyčkejte na email s dalšími instrukcemi.",

                  "normal_registrace_fail" => "Nastala chyba - tento login již v databázi existuje.",

                  "normal_registrace_fail_login" => "Nastala chyba - nebyl vyplněn login.",

                  "normal_registrace_fail_heslo" => "Nastala chyba - nebylo vyplněno heslo.",

                  "normal_registrace_fail_compare_heslo" => "Nastala chyba - hesla se neshodují.",

                  "normal_registrace_fail_email" => "Nastala chyba - email nebyl korektně zadán.",

                  "normal_registrace_fail_captcha" => "Nastala chyba - opsali jste špatně ověření.",



                  "normal_registrace_predmet" => "Registrace Mladi Podnikatele",

                  "normal_registrace_message" => "
Dobrý den,
<br />
Na Vašem portálu mladipodnikatele.cz se registroval uživatel s následujícími údaji:
<br /><br />
Login: %%login%%<br />
Email: %%email%%<br />
<br />
Registrace proběhla: %%datum%%
<br />
<br />
<br />
<b>Nyní se domluvte s tímto uživatelem na schůzce.<br />Napište mu email na <u>%%email%%</u></b>
<br />
<br />
<br />
",

                  "normal_registrace_header" => "from: info@mladipodnikatele.cz\r\nContent-type: text/html; charset=UTF-8",


                  "normal_registrace_user_predmet" => "Registrace Mladi Podnikatele",

                  "normal_registrace_user_message" => "
Dobrý den,
<br />
zažádal jste o registraci na portálu mladipodnikatele.cz
<br /><br />
<b>Vyčkejte prosím na email s dalšími instrukcemi. Vaše registrace bude potvrzena nebo zamítnuta až po osobním pohovoru.</b>
<br /><br /><br />
Zde jsou přihlašovací údaje pro pozdější přístup:
<br /><br />
Login: %%login%%<br />
Heslo: %%heslo%%<br /><br />
<br /><br />
",
                  ...
                  "normal_registrace_user_header" => "from: info@mladipodnikatele.cz\r\nContent-type: text/html; charset=UTF-8",



                  "normal_registrace_disable" => "",
...
%%7%%
        ...
        <form method=\"post\" action=\"\" id=\"zahlavi_prihlaseni\">
          <fieldset>
        ...
        <a href=\"%%4%%registrace\" title=\"Registrace\" id=\"zahlavi_registrace\"><!-- --></a>
        ...
        <p id=\"zahlavi_profil\">
          <span>Jsi přihlášen jako <strong>%%2%%</strong></span>
          <a href=\"%%1%%\" title=\"Profil\"><!-- --></a>
        </p>
        <p id=\"odhlasit_se\">
          <a href=\"%%3%%\" title=\"Odhlásit se\">Odhlásit se</a>
        </p>
...
<h2>%%6%% %%7%% <span>{upravit profil}</span></h2>



<div id=\"obal_sekce_upravit_profil\">
...
<div id=\"obal_sekce_upravit_profil\">
                  ...
                  "normal_profile_fail" => "Nastala chyba při úpravě profilu.",
...
%%4%%
      ...
      <label class=\"%%1%%\">
        ...
        <img src=\"%%4%%\" alt=\"\">
                  ...
                  "admin_vypis_user_row" => "%%1%% %%2%% <input type=\"checkbox\" disabled=\"disabled\"%%5%% />

                  <a href=\"%%6%%\">upravit</a>
                  <a href=\"%%7%%\" title=\"smazat uzivatele %%1%% ?\" class=\"confirm\">smazat</a>
                  <hr />",
