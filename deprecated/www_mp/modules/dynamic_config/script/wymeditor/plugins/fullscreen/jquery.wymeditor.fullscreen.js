...
WYMeditor.editor.prototype.fullscreen = function() {
 ...
 //construct the button's html
  var html = "<li class='wym_tools_fullscreen'>"
         + "<a title='Přepnout do celoobrazovkového režimu' name='Fullscreen' href='#'"
         + " style='background-image:"
         + " url(" + wym._options.basePath +"plugins/fullscreen/icon_fullscreen.png)'>"
  ...
  jQuery(wym._box).find('li.wym_tools_fullscreen a').click(function() {
    if (jQuery(wym._box).css('position') != 'fixed') {
      ...
      jQuery(wym._box).css({'position' : 'relative', 'z-index' : '99', 'height' : '100%', 'width' : '98%', 'top': '0px', 'left': '0px'});
    }
