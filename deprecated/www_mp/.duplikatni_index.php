...
$vypishledani = $this->var->main[0]->NactiFunkci("DynamicCentral", "CentralSearch");
...
$prihlasitse = $this->var->main[0]->NactiFunkci("DynamicRegistration", "LoginForm");


$this->var->main[0]->NactiFunkci("DynamicMail", "MailZachytavaniOdhlaseni");
$newsvlozmail = $this->var->main[0]->NactiFunkci("DynamicMail", "MailNaStrankach");
...
<p style=\"position: absolute; top: 60px; left: 30px; color: #fff; display: none;\">
Odpovědná osoba:<br />
Aleš Durďák<br />
tel: 776 16 72 74<br />
mail: info@mladipodnikatele.cz
</p>
