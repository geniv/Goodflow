...
lang : {
	...
	loadingTitle : 'Klikni pro stornování',
	focusTitle : 'Klikni pro přesunutí do popředí',
	fullExpandTitle : 'Zvětšit do skutečné velikosti (f)',
	creditsText : '',
	creditsTitle : '',
	...
	resizeTitle : 'Zvětšit obrázek',
	playText : 'Spusť',
	playTitle : 'Spusť slideshow (mezerník)',
	pauseText : 'Pauza',
	pauseTitle : 'Zapauzuj slideshow (mezerník)',
	previousTitle : 'Předchozí (šipka doleva)',
	nextTitle : 'Další (šipka doprava)',
	moveTitle : 'Přesunout obrázek',
	fullExpandText : 'Plná velikost (1:1)',
	number: 'Obrázek %1 z %2',
	restoreTitle : 'Kliknutím zavřete obrázek, kliknutím a přetažením můžete obrázek posunovat po stránkách. Použijte šipky pro další a předchozí obrázek.'
},
// See http://highslide.com/ref for examples of settings  
graphicsDir : 'obr/highslide/',
...
hs.addEventListener(window, 'load', function() {
	if (hs.expandCursor) {
		var sel = '.datovy_sklad .datovy_sklad_soubor .soubor .ikona_souboru a, .datovy_sklad_hierarchie_vypis .datovy_sklad_hierarchie_obsah ul li a.nahled_obrazku, .datovy_sklad_os_vypis .datovy_sklad_os_obsah ul li a.nahled_obrazku, .galerie_bez_sekci ul li.obrazek_nahled a, .pridat_upravit_obrazek_galerie_bez_sekci form label.input_file a', 
