 ...
 */
  public function __construct()
  {
    ...
    $this->var->main = new Funkce($this->var, 0, true);  //vytvoreni funkce
    ...
    if (!Empty($_POST["action"]))
    {
      switch ($_POST["action"])
      {
        ...
        case "getsize": //inerpretuje velikost
          $result = $this->var->main->Velikost($_POST["cesta"]);
        break;

        case "getadrsize": //zjisti velikost adresaru
          $rekurzivne = ($_POST["rek"] == "true");
          $result = $this->var->main->Velikost($this->var->main->VelikostAdresare($_POST["cesta"], $rekurzivne));
        break;
      }
    }
