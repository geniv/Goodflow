...
class TestControl extends NControl
{
	/** @persistent array */
	public $order;
...
NEnvironment::setVariable('appDir', dirname(__FILE__));

$uri = new NUriScript('http://localhost/index.php');
$uri->setScriptPath('/index.php');
$context = NEnvironment::getContext()->addService('Nette\\Web\\IHttpRequest', new NHttpRequest($uri));

$application = NEnvironment::getApplication();
$application->setRouter(new NSimpleRouter());

$request = new NPresenterRequest('Test', NHttpRequest::GET, array());
