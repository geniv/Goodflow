...
define('TEMP_FILE', dirname(__FILE__) . '/tmp/cfg.neon');


// Load INI
$config = NConfig::fromFile('config2.neon');
Assert::same( array(
	'common' => array(
		'variable' => array(
	...
	'production' => array(
		'service' => array(
			'IRouter' => 'Nette\\Application\\MultiRouter',
			'User' => 'Nette\\Security\\User',
			'Autoloader' => 'Nette\\AutoLoader',
		),
...
$config = NConfig::fromFile('config2.neon', 'development');
Assert::same( array(
	'database' => array(
		'params' => array(
			'host' => 'dev.example.com',
