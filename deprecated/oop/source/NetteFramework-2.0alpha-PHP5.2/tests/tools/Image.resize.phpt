...
$main = NImage::fromFile('files/images/logo.gif');
$image = clone $main;
...
$image->resize(300, 150, NImage::ENLARGE);
...
$image->resize(300, 100, NImage::ENLARGE | NImage::STRETCH);
...
$image->resize(300, 100, NImage::STRETCH);
Assert::same( 176, $image->width, 'width' );
