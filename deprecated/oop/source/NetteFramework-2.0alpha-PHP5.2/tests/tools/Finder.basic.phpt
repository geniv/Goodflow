...
$finder = NFinder::findFiles('file.txt')->in('files');
Assert::same(array('files/file.txt'), export($finder));


// recursive file search
$finder = NFinder::findFiles('file.txt')->from('files');
Assert::same(array(
	'files/file.txt',
...
$finder = NFinder::find('file.txt')->from('files');
Assert::same(array(
	'files/file.txt',
	'files/images',
	'files/subdir',
...
$finder = NFinder::findDirectories('subdir*')->from('files');
Assert::same(array(
	'files/subdir',
	'files/subdir/subdir2',
), export($finder));
