...
/**
 * Test: NObject extension method via interface.
 *
 * @author     David Grudl
 * @package    Nette
...
NClassReflection::from('IFirst')->setExtensionMethod('join', 'IFirst_join');
NClassReflection::from('ISecond')->setExtensionMethod('join', 'ISecond_join');
