...
/**
 * Test: NHttpRequest invalid encoding.
 *
 * @author     David Grudl
 * @package    Nette\Web
...
Assert::true( $request->getFile(INVALID) instanceof NHttpUploadedFile );
Assert::true( $request->getFile(CONTROL_CHARACTERS) instanceof NHttpUploadedFile );
