...
$template->setFile(dirname(__FILE__) . '/templates/helpers.latte');
...
Assert::match(file_get_contents(dirname(__FILE__) . '/LatteFilter.macros.003.expect'), $template->__toString(TRUE));
