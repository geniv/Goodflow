 ...
 */
class GameQ_Protocol_ventrilo extends Protocol
{
	...
	public function preprocess($packets)
	{
		...
		foreach ($packets as $packet)
		{
			...
			if ($a1 == 0)
			{
				throw new ParsingException("Header key is invalid");
			}
			...
			{
				throw new ParsingException("Too less packets recieved");
			}
			...
			if ( $a1 == 0 ) {
				throw new ParsingException("Data key is invalid");
			}
