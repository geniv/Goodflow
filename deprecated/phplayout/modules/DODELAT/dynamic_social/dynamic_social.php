...
/**
 *
 * Blok socialniho modulu
 *
 */

class DynamicSocial extends DefaultModule
{
  private $var, $dirpath, $absolutni_url, $unikatni, $dbpredpona, $mainindex;
  public $idmodul = "dynsoc";  //id pro rozliseni modulu v adminu
  //rivate $idlog = "_logy";
  public $mount = array(".unikatni_obsah.php");  //corn je pripojeny v korenu!../../cron.php
