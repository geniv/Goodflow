...
%%28%% - (28)<br />
                  ...
                  "normal_registrace_email_header_0_1" => "%%1%%\nFrom: prednasky@kavarnajantar.cz",

                  "normal_registrace_email_subject_0_1" => "p&#345;edm&#283;t zpr&aacute;vy",

                  "normal_registrace_email_text_0_1" => "
...
%%10%% - 10<br />
%%11%% - 11<br />
prokazovací kod vám bude vygenerován a zaslan až po ověření a aktivaci 'učtu'

                  ",

                  "normal_registrace_true_0_1" => "
                  uspěšně registrováno, odesláno na email: %%1%%,
                  pod jménem %%2%% %%3%%,
                  a máte čas na potvrzení do: %%4%%, pak emailu vypřší platnost
                  ",

                  "normal_registrace_autoclick_0_1" => false,

                  "normal_registrace_autoclick_time_0_1" => 5,  //s

//------------------------------------------------------------------------------

                  "normal_registrace_email_header_1_1" => "%%1%%\nFrom: prednasky@kavarnajantar.cz",

                  "normal_registrace_email_subject_1_1" => "p&#345;edm&#283;t zpr&aacute;vy",

                  "normal_registrace_email_text_1_1" => "
...
prokazovací kod vám bude vygenerován a zaslan až po ověření a aktivaci 'učtu'
                  ...
                  "normal_registrace_true_1_1" => "
                  uspěšně registrováno, odesláno na email: %%1%%,
                  pod jménem %%2%% %%3%%,
                  a máte čas na potvrzení do: %%4%%, pak emailu vypřší platnost
                  ",

                  "normal_registrace_autoclick_1_1" => false,

                  "normal_registrace_autoclick_time_1_1" => 5,  //s
...
%%10%% - 10<br />
                  ...
                  "admin_vypis_tvar_datum" => "d.m.Y H:i",

                  "admin_vypis_obsah_tvar_datum" => "d.m.Y H:i:s",

                  "admin_vypis_obsah_skupiny_open_full" => "Registrace otevřena, plná kapacita",

                  "admin_vypis_obsah_skupiny_open" => "Registrace otevřena",

                  "admin_vypis_obsah_skupiny_close_full" => "Registrace uzavřena, plná kapacita",
...
<div class=\"dynamicke_prihlasovani_vypis_uzivatelu\">
  ...
  <p class=\"odkazy_registrace_uzivatele\">
    ...
    <span>
      <a href=\"%%14%%\" title=\"Informace o registraci\">Informace o registraci</a> - <a href=\"%%13%%\" title=\"Smazat všechny uživatele\" onclick=\"return confirm('Opravdu chceš smazat všechny uživatele: &quot;%%3%%&quot; ?');\">Smazat všechny uživatele</a>
    </span>
  </p>
...
<li><span class=\"urceni_sortovani\">%%20%% %%19%%</span>
  <ul class=\"registrovani_uzivatele%%14%%\" id=\"registrovani_uzivatele_id_%%1%%\">
    ...
    %%11%%
                  ...
                  "admin_vypis_obsah_noautoexpire" => "Uživatel byl automaticky potvrzen",
                  ...
                  //dane
                  "set_vyhodnoceni" => array ("Kontrola na aktivované uživatele [s expirací]",
                                              "Kontrola na přidané uživatele [bez expirace]",
                                              //"Kontrola na přidané uživatele [s expirací]",
                                              ),
...
<div class=\"central_absolutni central_info\">
  ...
  <p class=\"odkaz_pokracovat\">
    Vyčkejte, než se stránka sama obnoví.
                  ...
                  "admin_addedit_tvar_datum" => "Y-m-d H:i",
                  ...
                  "admin_deftvar_prefix" => "10->99|10->99|10->99",
...
<div class=\"central_absolutni central_info\">
  ...
  <p class=\"odkaz_pokracovat\">
    Vyčkejte, než se stránka sama obnoví.
                  ...
                  "admin_pdf_vypis_open_full" => "otevřená, plná",

                  "admin_pdf_vypis_open" => "otevřená",

                  "admin_pdf_vypis_close_full" => "uzavřená, plná",
...
<div class=\"zahlavi_registrace\">
  <ul>
    ...
    <li>Počet zaregistrovaných lidí: <strong>%%9%%</strong></li>
    <li>Počet lidí, kteří potvrdili registraci: <strong>%%8%%</strong></li>
...
<table class=\"urceni_strany\" width=\"100%\" style=\"font-size: 9px;\">
  <tr>
    <td width=\"100%\" style=\"text-align: right;\">Strana {PAGENO} z {nb}</td>
                  ...
                  "admin_duplikace_email_null" => "",

                  "admin_pocty_brow_null" => "",

                  "admin_pocty_os_null" => "",

                  "admin_pocty_osbrow_null" => "",

                  "admin_prodlevy_null" => "",

                  "admin_duplikace_email_begin" => "
<table summary=\"\">
  <tr>
    <th>ID uživatele</th>
    <th>E-mail</th>
    ...
    <td>%%3%%</td>
                  ...
                  "admin_duplikace_email_end" => "</table>\n",


                  //vypis poctu prohlizecu
                  "admin_pocty_brow_begin" => "
<table summary=\"\">
  <tr>
    <th>Počet</th>
    <th>Prohlížeč</th>
    ...
    <td>%%1%%</td>
                  ...
                  "admin_pocty_brow_end" => "</table>\n",


                  //vypis poctu operacnich systemu
                  "admin_pocty_os_begin" => "
<table summary=\"\">
  <tr>
    <th>Počet</th>
    ...
    <td>%%1%%</td>
                  ...
                  "admin_pocty_os_end" => "</table>\n",


                  //vypis operacnich systemu a prohlizecu
                  "admin_pocty_osbrow_begin" => "
<table summary=\"\">
  <tr>
    <th>Počet</th>
    <th>Prohlížeč</th>
    <th>Operační systém</th>
                  ...
                  "admin_pocty_osbrow" => "  <tr>
    <td>%%3%%</td>
    <td>%%2%%</td>
    <td>%%1%%</td>
  </tr>\n",

                  "admin_pocty_osbrow_end" => "</table>\n",


                  //vypis poctu operacnich systemu
                  "admin_prodlevy_begin" => "
<table summary=\"\">
  <tr>
    <th>Počet</th>
    <th>Datum / čas</th>
                  ...
                  "admin_prodlevy_tvar_datum" => "d.m.Y / H:i:s",
    ...
    <td>%%2%%</td>
                  ...
                  "admin_prodlevy_end" => "</table>\n",


                  "admin_infoakce_tvar_datum" => "d.m.Y / H:i:s",
//<br /> %mm [měsíc] <br /> %yyyy [rok]
                  "admin_infoakce_delka_tvar_datum" => "%dd [den] <br /> %H:%M:%S [čas]",

                  "admin_infoakce" => "
<script type=\"text/javascript\" src=\"%%1%%/script/jquery-1.3.2.min.js\"></script>
<div class=\"pridat_upravit_dynamicke_prihlasovani\">
  <h3>Informace o registraci</h3>
  <p class=\"backlink_prihlasovani\">
    <a href=\"%%10%%\" title=\"Zpět na výpis přihlašování\">Zpět na výpis přihlašování</a>
  </p>
<table summary=\"\" class=\"nadpisy_tabulky\">
  <tr>
    <th>Duplicitní emaily</th>
  </tr>
</table>
%%2%%
<table summary=\"\" class=\"nadpisy_tabulky\">
  <tr>
    <th>Použité prohlížeče</th>
  </tr>
</table>
%%3%%
<table summary=\"\" class=\"nadpisy_tabulky\">
  <tr>
    <th>Použité operační systémy</th>
  </tr>
</table>
%%4%%
<table summary=\"\" class=\"nadpisy_tabulky\">
  <tr>
    <th>Použité operační systémy a prohlížeče</th>
  </tr>
</table>
%%5%%
<table summary=\"\" class=\"nadpisy_tabulky\">
  <tr>
    <th>Výpis data a času registrace</th>
  </tr>
</table>
%%6%%
<table summary=\"\" class=\"nadpisy_tabulky\">
  <tr>
    <th>Doplňující informace data a času registrace</th>
  </tr>
</table>
<table summary=\"\">
  <tr>
    <th>Datum / čas první registrace</th>
    <th>Datum / čas poslední registrace</th>
  </tr>
  <tr>
    <td>%%7%%</td>
    <td>%%8%%</td>
...
<div class=\"pridat_upravit_dynamicke_prihlasovani\">
  ...
  <p class=\"backlink_prihlasovani\">
    <a href=\"%%18%%\" title=\"Zpět na výpis přihlašování\">Zpět na výpis přihlašování</a>
  </p>
  <ul>
    ...
    <li>Pořadí registrace: <strong>#%%16%%</strong></li>
  </ul>
</div>\n",
  ...
  <form method=\"post\" action=\"\">
    <fieldset>
      ...
      <label class=\"input_text\">
        ...
        <input type=\"text\" name=\"expirace\" value=\"%%9%%\" disabled=\"disabled\" />
      </label>
      <label class=\"input_text\">
