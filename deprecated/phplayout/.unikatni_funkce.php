...
<div id=\"obal_razeni\" class=\"cl-b\">\n",
                  ...
                  "admin_vypis_module" => "
<ul class=\"f-f-web-pro f-s-14 m-b-15\" id=\"arrayporadi_%%id%%\">
  <li class=\"nadpis-2 f-s-16 p-t-6 p-r-10 p-b-6 p-l-10 cur-move ow-h\"><span class=\"fl-l\">%%existsinclude%%%%class%%</span><span class=\"block fl-r f-s-14 m-t-1 ow-h\"><a href=\"%%editmod%%\" title=\"Upravit modul\" class=\"editmod block fl-l m-r-5 m-l-5 no-u odkaz-4\">Upravit modul</a>%%delmod%%%%clemoddeldb%%</span></li>
  <li class=\"polozka-1-lichy p-t-3 p-r-10 p-b-3 p-l-10 ow-h\"><span class=\"fl-l barva-4\">Cesta:</span><span class=\"fl-r barva-5\">%%include%%</span></li>
  <li class=\"polozka-1-sudy p-t-3 p-r-10 p-b-3 p-l-10 ow-h\"><span class=\"fl-l barva-4\">Administrátorské prostředí:</span><span class=\"fl-r barva-5\"><input type=\"checkbox\" disabled=\"disabled\"%%admin%% class=\"block m-t-2\" /></span></li>
  <li class=\"polozka-1-lichy p-t-3 p-r-10 p-b-3 p-l-10 ow-h\"><span class=\"fl-l barva-4\">Zvolená databáze:</span><span class=\"fl-r barva-5\">%%typdatabaze%%</span></li>
  <li class=\"polozka-1-sudy p-t-3 p-r-10 p-b-3 p-l-10 ow-h\"><span class=\"fl-l barva-4\">Název databáze:</span><span class=\"fl-r barva-5\">%%databaze%%</span></li>
  <li class=\"polozka-1-lichy p-t-3 p-r-10 p-b-3 p-l-10 ow-h\"><span class=\"fl-l barva-4\">Aktivní modul:</span><span class=\"fl-r barva-5\"><input type=\"checkbox\"%%aktivni%%%%securemodule%% class=\"block m-t-2 cur-poi\" /></span></li>
</ul>\n",
