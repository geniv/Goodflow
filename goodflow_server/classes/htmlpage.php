...
//TODO wtf?!
      $meta = array(Html::elem('meta', array('http-equiv' => 'Content-Type', 'content' => 'text/html; charset=UTF-8')),
                    Html::elem('meta', array('http-equiv' => 'Content-Language', 'content' => $this->page->conf->lang)),
                    );
