...
// proměnná pro uložení počátečního času
...
function gameloop()
{
	...
	if (audiogame.startingTime != 0)
	{
		...
		{
		  // určení času, který uplynul od spuštění hry
			var date = new Date();
			...
			{
        // pokud se čas zobrazení neliší od uplynulého času 
        // o více jak délku prodlevy mezi voláními herní smyčky, 
        // vytvoří se bod
