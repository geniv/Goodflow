...
function gameloop() {	
	...
	ctx.fillText("Hra Untangle",ctx.canvas.width/2,50);
	
	// zobrazení postupu ve hře
	ctx.textAlign = "left";
	ctx.textBaseline = "bottom";
	ctx.fillText("Úroveň "+untangleGame.currentLevel+", Dokončeno: " + untangleGame.progressPercentage + "%", 20,ctx.canvas.height-5);
}
