...
$(function() {
	...
	// nastavení stavu hry na "úvodní obrazovka"
	carGame.state = carGame.STATE_STARTING_SCREEN;
	
	// po klepnutí na úvodní obrazovku se hra spustí
	$('#game').click(function(){
		if (carGame.state == carGame.STATE_STARTING_SCREEN)
		{
			// změna stavu na "spuštěna"
...
{
	$("#level").html("Úroveň " + (level+1));
	
	carGame.currentLevel = level;
	
	// nastavení pozadí podle aktuální úrovně
