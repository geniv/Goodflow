...
classes\DateAndTime::setDateTimezone('Europe/Prague');


// $cur = new classes\Curl('http://www.useragentstring.com/');
// $cur->addHttpHeader('Content-Type: application/xml')
//     ->addHttpHeader('Accept: application/xml');
//     // ->setUrl('http://www.useragentstring.com/');
// $res = $cur->get(array('uas' => $_SERVER['HTTP_USER_AGENT'], 'getJSON' => 'all'));
// var_dump($res);
// var_dump($cur->exec());

// var_dump(classes\Curl::factory('http://www.useragentstring.com/')->get(array('uas' => $_SERVER['HTTP_USER_AGENT'], 'getJSON' => 'all')));

$c = new classes\Curl('http://localhost/www/git/goodflow/sandbox/put.php');
$c->setFile('file1', 'pokus.sqlite2');
$c->setFile(array('a' => 'pokus.sqlite2', 'b' => 'pokus.sqlite2'));
// var_dump($c->get(array('h' => 'a')));
// var_dump($c->post(array('d' => 1)));
var_dump($c->post());



// Create a cURL handle
// $ch = curl_init('http://localhost/www/git/goodflow/sandbox/put.php');
// Create a CURLFile object
// $cfile = new \CURLFile('pokus.sqlite2');
// Assign POST data
// $data = array('test_file' =>  new \CURLFile('pokus.sqlite2'), 'data2' => new \CURLFile('pokus.sqlite2'));
// curl_setopt($ch, CURLOPT_POST,true);
// curl_setopt($ch, CURLOPT_POSTFIELDS, $data);
// Execute the handle
// curl_exec($ch);

// var_dump(headers_list(), apache_response_headers());

// var_dump($c->get(array('a' => 22)));



//TODO oprasit nette 2.2. od bordelu, vystavit full, mini a layout verzi
//moduly ktere jsou v Core uzpusobit k nette nebo vyhodit ty ktere jsou jen duplikaty nette?!
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// ".:/usr/local/zend/share/ZendFramework/library:/usr/local/zend/share/pear:/usr/share/php"
///
